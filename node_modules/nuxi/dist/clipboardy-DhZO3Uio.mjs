...
const makeError$1 = ({ stdout: stdout$1, stderr, all, error, signal, exitCode, command, escapedCommand, timedOut, isCanceled, killed, parsed: { options: { timeout, cwd = process$1.cwd() } } }) => {
...
var require_merge_stream = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/merge-stream@2.0.0/node_modules/merge-stream/index.js": ((exports, module) => {
