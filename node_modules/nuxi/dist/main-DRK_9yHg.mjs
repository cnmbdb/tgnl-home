...
var h = /* @__PURE__ */ ((t) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(t, { get: (e, n) => (typeof require < "u" ? require : e)[n] }) : t)(function(t) {
...
var et = l((Re, tt) => {
	var g = process.platform === "win32" || process.env.OSTYPE === "cygwin" || process.env.OSTYPE === "msys", Y = h("path"), Bt = g ? ";" : ":", V = U(), J = (t) => Object.assign(/* @__PURE__ */ new Error(`not found: ${t}`), { code: "ENOENT" }), Q = (t, e) => {
...
//#endregion
export { x as i, be as n, ve as r, R as t };