...
const napi = {
	...
	napi_create_promise(env_id, deferred, promise) {
		let env$2 = environments[env_id];
		let p = new Promise((resolve$1, reject) => {
	...
	napi_resolve_deferred(env_id, deferred, resolution) {
		let env$2 = environments[env_id];
		let { resolve: resolve$1 } = env$2.deferred[deferred];
		resolve$1(env$2.get(resolution));
...
var require_wrapper = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/@parcel+watcher-wasm@2.5.1/node_modules/@parcel/watcher-wasm/wrapper.js": ((exports) => {
...
var import_wrapper = /* @__PURE__ */ __toESM(require_wrapper(), 1);
let env$1;
