...
import { o as v } from "./dist-KRhCJXtj.mjs";
import { r as version } from "./package-DOSBMWU1.mjs";
...
import { n as tryResolveNuxt } from "./kit-DG9dDPei.mjs";
import { n as readPackageJSON } from "./dist-DlZYgmvt.mjs";
import "./main-DRK_9yHg.mjs";
import { r as detectPackageManager } from "./nypm.CLjaS_sz-BpnbjyUz.mjs";
import { i as splitByCase } from "./dist-B0CHr6mz.mjs";
import { t as getPackageManagerVersion } from "./packageManagers-D8UmuFsE.mjs";
import process$1 from "node:process";
import os from "node:os";

//#region ../../node_modules/.pnpm/copy-paste@2.2.0/node_modules/copy-paste/platform/darwin.js
var require_darwin = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/copy-paste@2.2.0/node_modules/copy-paste/platform/darwin.js": ((exports) => {
	exports.copy = {
		command: "pbcopy",
		args: [],
...
var require_lib = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/iconv-lite@0.4.24/node_modules/iconv-lite/lib/index.js": ((exports, module) => {
...
var require_win32 = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/copy-paste@2.2.0/node_modules/copy-paste/platform/win32.js": ((exports) => {
...
var require_linux_wayland = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/copy-paste@2.2.0/node_modules/copy-paste/platform/linux-wayland.js": ((exports) => {
...
var require_linux = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/copy-paste@2.2.0/node_modules/copy-paste/platform/linux.js": ((exports) => {
	exports.copy = process.env.WSL_DISTRO_NAME ? {
		command: "clip.exe",
		args: []
	} : {
...
var require_android = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/copy-paste@2.2.0/node_modules/copy-paste/platform/android.js": ((exports) => {
	exports.copy = {
...
var require_copy_paste = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/copy-paste@2.2.0/node_modules/copy-paste/index.js": ((exports) => {
...
var import_copy_paste = /* @__PURE__ */ __toESM(require_copy_paste(), 1);
var info_default = defineCommand({
	...
	async run(ctx) {
		...
		const infoObj = {
			...
			UserConfig: Object.keys(nuxtConfig).map((key$1) => `\`${key$1}\``).join(", "),
		...
		let maxLength = 0;
		const entries = Object.entries(infoObj).map(([key$1, val]) => {
			const label = splitByCase(key$1).join(" ");
		...
		const copied = !v && await new Promise((resolve$1) => (0, import_copy_paste.copy)(infoStr, (err) => resolve$1(!err)));
...
async function getNuxtConfig(rootDir) {
	try {
		const { createJiti } = await import("./jiti-D7p8f1lo.mjs");
