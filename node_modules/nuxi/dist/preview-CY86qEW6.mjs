...
import { n as box, r as colors } from "./dist-D6bEcHI0.mjs";
...
import { c as resolve$1 } from "./pathe.M-eThtNZ-KQ2nQL0i.mjs";
...
import { n as setupDotenv } from "./c12.8GPsgFQh-BPkPk7vk.mjs";
...
const command = defineCommand({
	...
	async run(ctx) {
		...
		logger.log("");
		await ve(command$1, commandArgs, {
			throwOnError: true,
			nodeOptions: {
				stdio: "inherit",
				cwd: outputPath,
