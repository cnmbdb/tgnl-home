...
import { t as defu } from "./defu-BMWEZS2o.mjs";
import "./dist-Co27RTKx.mjs";
import "./dist-A4GfTVP-.mjs";
import { a as join, c as resolve$1, n as dirname$1, s as relative, t as basename } from "./pathe.M-eThtNZ-KQ2nQL0i.mjs";
import "./kit-DG9dDPei.mjs";
import "./fs-B3CNiWYf.mjs";
import { i as writePackageJSON, n as readPackageJSON, t as findFile } from "./dist-DlZYgmvt.mjs";
import { r as ve } from "./main-DRK_9yHg.mjs";
import { i as installDependencies } from "./nypm.CLjaS_sz-BpnbjyUz.mjs";
import { n as require_node_fetch_native_DhEqb06g, t as require_node } from "./node-Jr1Bfqcg.mjs";
import "./jiti-wWTtJ1RY.mjs";
import "./node-CYFB0qr5.mjs";
import "./satisfies-phYInBJ6.mjs";
import "./semver-o-01em3A.mjs";
import { i as $fetch } from "./_utils-DFWSyyEL.mjs";
...
var require_proxy = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/node-fetch-native@1.6.7/node_modules/node-fetch-native/dist/proxy.cjs": ((exports) => {
	...
	function requireRequest$1() {
		...
		const { InvalidArgumentError: A, NotSupportedError: k$1 } = requireErrors(), c$5 = require$$0__default$1, { isValidHTTPToken: B, isValidHeaderValue: t$6, isStream: y$3, destroy: R$3, isBuffer: F$3, isFormDataLike: Q, isIterable: D, isBlobLike: U, buildURL: r, validateHandler: o$6, getServerName: N, normalizedMethodRecords: l$1 } = requireUtil$7(), { channels: I } = requireDiagnostics(), { headerNameLowerCasedRecord: p$1 } = requireConstants$4(), b = /[^\u0021-\u00ff]/, G$1 = Symbol("handler"), _$1 = class _$2 {
			constructor(M, { path: Y, method: m$3, body: f$4, headers: n$4, query: C$1, idempotent: w$2, blocking: S$1, upgrade: x, headersTimeout: z$1, bodyTimeout: $, reset: K, throwOnError: nA, expectContinue: iA, servername: uA }, RA) {
				...
				if (this.completed = !1, this.aborted = !1, this.upgrade = x || null, this.path = C$1 ? r(Y, C$1) : Y, this.origin = M, this.idempotent = w$2 ?? (m$3 === "HEAD" || m$3 === "GET"), this.blocking = S$1 ?? !1, this.reset = K ?? null, this.host = null, this.contentLength = null, this.contentType = null, this.headers = [], this.expectContinue = iA ?? !1, Array.isArray(n$4)) {
		...
		function p$1(q$1, M) {
			...
			for (C$1 !== q$1.length && (q$1 = q$1.subarray(0, C$1));;) {
				...
				let K;
				{
					...
					K = q$1.subarray(n$4.position, iA - 4), n$4.position += K.length, $ === "base64" && (K = Buffer.from(K.toString(), "base64"));
				}
				if (q$1[n$4.position] !== 13 || q$1[n$4.position + 1] !== 10) return "failure";
				n$4.position += 2;
				let nA;
				x !== null ? (z$1 ?? (z$1 = "text/plain"), l$1(z$1) || (z$1 = ""), nA = new D([K], x, { type: z$1 })) : nA = c$5(Buffer.from(K)), F$3(A(S$1)), F$3(typeof nA == "string" && A(nA) || y$3(nA)), f$4.push(R$3(S$1, nA, x));
			}
		}
...
`).replace(/%0D/gi, "\r").replace(/%22/g, "\""), Y);
	...
	function requireBody() {
		...
		let M;
		q$1 && (M = new FinalizationRegistry((K) => {
			const nA = K.deref();
...
`);
		...
		function f$4(K, nA) {
			...
			return q$1 && M.register(K, new WeakRef(iA)), nA.stream = iA, {
				stream: uA,
				length: nA.length,
				source: nA.source
			};
		...
		async function S$1(K, nA, iA) {
			if (r.brandCheck(K, iA), x(K)) throw new TypeError("Body is unusable: Body has already been read");
			n$4(K[U]);
			...
			return K[U].body == null ? (IA(Buffer.allocUnsafe(0)), uA.promise) : (await R$3(K[U].body, IA, RA), uA.promise);
		}
		e$6(S$1, "consumeBody");
		function x(K) {
			const nA = K[U].body;
		...
		function $(K) {
			const nA = K[U].headersList, iA = F$3(nA);
		...
		const PA = 0, ZA = 1, HA = 2 | ZA, se = 4 | ZA, ne = 8 | PA, oe = class oe$1 {
			...
			onHeadersComplete(eA, lA, BA) {
				...
				if (A((this.headers.length & 1) === 0), this.headers = [], this.headersSize = 0, this.shouldKeepAlive && hA[S$1]) {
					...
					if (v$2 != null) {
						const X$2 = Math.min(v$2 - hA[nA], hA[K]);
...
`, "latin1"), lA !== null && hA !== lA) {
	...
	function requireClientH2() {
		...
		const { constants: { HTTP2_HEADER_AUTHORITY: C$1, HTTP2_HEADER_METHOD: w$2, HTTP2_HEADER_PATH: S$1, HTTP2_HEADER_SCHEME: x, HTTP2_HEADER_CONTENT_LENGTH: z$1, HTTP2_HEADER_EXPECT: $, HTTP2_HEADER_STATUS: K } } = n$4;
		function nA(aA) {
			const EA = [];
...
`, this[nA] = ie ?? 3e5, this[K] = LA ?? 3e5, this[iA] = zA ?? !0, this[RA] = AA, this[IA] = X$2, this[dA] = null, this[DA] = tA > -1 ? tA : -1, this[EA] = TA ?? 100, this[aA] = null, this[V] = [], this[n$4] = 0, this[f$4] = 0, this[sA] = (YA) => ne(this, YA), this[oA] = (YA) => ZA(this, YA);
			}
			get pipelining() {
				return this[w$2];
			}
		...
		const A = requireDispatcherBase(), k$1 = requireFixedQueue(), { kConnected: c$5, kSize: B, kRunning: t$6, kPending: y$3, kQueued: R$3, kBusy: F$3, kFree: Q, kUrl: D, kClose: U, kDestroy: r, kDispatch: o$6 } = requireSymbols$4(), N = requirePoolStats(), l$1 = Symbol("clients"), I = Symbol("needDrain"), p$1 = Symbol("queue"), b = Symbol("closed resolve"), G$1 = Symbol("onDrain"), J$1 = Symbol("onConnect"), V = Symbol("onDisconnect"), _$1 = Symbol("onConnectionError"), q$1 = Symbol("get dispatcher"), M = Symbol("add client"), Y = Symbol("remove client"), m$3 = Symbol("stats"), n$4 = class n$5 extends A {
			constructor() {
				...
				this[G$1] = e$6(function(x, z$1) {
					...
					this[I] = K, !this[I] && w$2[I] && (w$2[I] = !1, w$2.emit("drain", x, [w$2, ...z$1])), w$2[b] && $.isEmpty() && Promise.all(w$2[l$1].map((nA) => nA.close())).then(w$2[b]);
	...
	function requireProxyAgent() {
		...
		const V = e$6(() => {}, "noop"), f$4 = class f$5 extends F$3 {
			constructor(w$2) {
				...
				const x = ee(this, Y, Je).call(this, w$2), { href: z$1, origin: $, port: K, protocol: nA, username: iA, password: uA, hostname: RA } = x;
				if (this[A] = {
					uri: z$1,
					protocol: nA
	...
	function requireEnvHttpProxyAgent() {
		var l$1, I, p$1, b, ve$1, He, Ne, Ve, me$1;
		...
		l$1 = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), p$1 = /* @__PURE__ */ new WeakMap(), b = /* @__PURE__ */ new WeakSet(), ve$1 = e$6(function(f$4) {
	...
	function requireMockUtils() {
		...
		function I(C$1, { path: w$2, method: S$1, body: x, headers: z$1 }) {
			const $ = D(C$1.path, w$2), K = D(C$1.method, S$1), nA = typeof C$1.body < "u" ? D(C$1.body, x) : !0, iA = N(C$1, z$1);
			return $ && K && nA && iA;
		}
		e$6(I, "matchKey");
		function p$1(C$1) {
		...
		function _$1(C$1) {
			...
			for (let x = 0; x < w$2.length; ++x) {
				const z$1 = w$2[x], $ = C$1[z$1], K = Buffer.from(`${z$1}`);
				if (Array.isArray($)) for (let nA = 0; nA < $.length; ++nA) S$1.push(K, Buffer.from(`${$[nA]}`));
				else S$1.push(K, Buffer.from(`${$}`));
			}
			return S$1;
		}
		...
		function Y(C$1, w$2) {
			...
			const { data: { statusCode: z$1, data: $, headers: K, trailers: nA, error: iA }, delay: uA, persist: RA } = x, { timesInvoked: IA, times: CA } = x;
...
`.trim());
			...
			*[Symbol.iterator]() {
			...
			toSortedArray() {
				...
				if (f$4 <= 32) {
					...
					for (let S$1 = 1, x = 0, z$1 = 0, $ = 0, K = 0, nA, iA; S$1 < f$4; ++S$1) {
						for (iA = C$1.next().value, nA = n$4[S$1] = [iA[0], iA[1].value], R$3(nA[1] !== null), $ = 0, z$1 = S$1; $ < z$1;) K = $ + (z$1 - $ >> 1), n$4[K][0] <= nA[0] ? $ = K + 1 : z$1 = K;
						if (S$1 !== K) {
	...
	function requireFetch() {
		...
		async function GA(AA, v$2 = !1) {
			...
			let j$2 = null;
			if (X$2.localURLsOnly && !K(p$1(X$2)) && (j$2 = A("local URLs only")), G$1(X$2), o$6(X$2) === "blocked" && (j$2 = A("bad port")), X$2.referrerPolicy === "" && (X$2.referrerPolicy = X$2.policyContainer.referrerPolicy), X$2.referrer !== "no-referrer" && (X$2.referrer = M(X$2)), j$2 === null && (j$2 = await (async () => {
				const rA = p$1(X$2);
	...
	function requireCache() {
		...
		const { kConstruct: A } = requireSymbols$1(), { urlEquals: k$1, getFieldValues: c$5 } = requireUtil$3(), { kEnumerableProperty: B, isDisturbed: t$6 } = requireUtil$7(), { webidl: y$3 } = requireWebidl(), { Response: R$3, cloneResponse: F$3, fromInnerResponse: Q } = requireResponse(), { Request: D, fromInnerRequest: U } = requireRequest(), { kState: r } = requireSymbols$3(), { fetching: o$6 } = requireFetch(), { urlIsHttpHttpsScheme: N, createDeferredPromise: l$1, readAllBytes: I } = requireUtil$6(), p$1 = require$$0__default$1, m$3 = class m$4 {
			...
			async delete(n$4, C$1 = {}) {
				...
				return queueMicrotask(() => {
					K === null ? $.resolve(!!nA?.length) : $.reject(K);
				}), $.promise;
			}
			async keys(n$4 = void 0, C$1 = {}) {
				...
				if (n$4 === void 0) for (const $ of Z(this, J$1)) z$1.push($[0]);
					...
					for (const K of $) z$1.push(K[0]);
				}
				return queueMicrotask(() => {
					const $ = [];
					for (const K of z$1) {
						const nA = U(K, new AbortController().signal, "immutable");
						$.push(nA);
					}
		...
		J$1 = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakSet(), pe = e$6(function(n$4) {
			...
			for (const z$1 of x) {
				const [$, K] = z$1;
				ee(this, V, Oe).call(this, n$4, $, K, C$1) && S$1.push(z$1);
			}
			return S$1;
			...
			for (const K of $) {
				if (K === "*") return !1;
				if (C$1.headersList.get(K) !== n$4.headersList.get(K)) return !1;
			}
			return !0;
	...
	function requireUtil$1() {
		...
		e$6(I, "isClosed");
		function p$1(x, z$1, $ = (nA$1, iA) => new Event(nA$1, iA), K = {}) {
			const nA = $(x, K);
		...
		function b(x, z$1, $) {
			...
			else z$1 === R$3.BINARY && (x[B] === "blob" ? K = new Blob([$]) : K = G$1($));
			p$1("message", x, Q, {
				origin: x[t$6].origin,
				data: K
			});
		...
		function _$1(x, z$1) {
			const { [k$1]: $, [c$5]: K } = x;
			$.abort(), K?.socket && !K.socket.destroyed && K.socket.destroy(), z$1 && p$1("error", x, (nA, iA) => new F$3(nA, iA), {
				error: new Error(z$1),
				message: z$1
			});
		}
	...
	function requireConnection() {
		...
		function f$4(S$1, x, z$1, $) {
			if (!(o$6(S$1) || N(S$1))) if (!l$1(S$1)) r(S$1, "Connection was closed before it was established."), S$1[y$3] = k$1.CLOSING;
				...
				const K = new M();
				x !== void 0 && z$1 === void 0 ? (K.frameData = Buffer.allocUnsafe(2), K.frameData.writeUInt16BE(x, 0)) : x !== void 0 && z$1 !== void 0 ? (K.frameData = Buffer.allocUnsafe(2 + $), K.frameData.writeUInt16BE(x, 0), K.frameData.write(z$1, 2, "utf-8")) : K.frameData = B, S$1[D].socket.write(K.createFrame(t$6.CLOSE)), S$1[R$3] = c$5.SENT, S$1[y$3] = k$1.CLOSING;
		...
		function C$1() {
			...
			nA && !nA.error ? ($ = nA.code ?? 1005, K = nA.reason) : S$1[Q] || ($ = 1006), S$1[y$3] = k$1.CLOSED, U("close", S$1, (iA, uA) => new b(iA, uA), {
				wasClean: z$1,
				code: $,
				reason: K
	...
	function requireReceiver() {
		...
		const { Writable: A } = Stream__default, k$1 = require$$0__default$1, { parserStates: c$5, opcodes: B, states: t$6, emptyBuffer: y$3, sentCloseFrameState: R$3 } = requireConstants(), { kReadyState: F$3, kSentClose: Q, kResponse: D, kReceivedClose: U } = requireSymbols(), { channels: r } = requireDiagnostics(), { isValidStatusCode: o$6, isValidOpcode: N, failWebsocketConnection: l$1, websocketMessageReceived: I, utf8Decode: p$1, isControlFrame: b, isTextBinaryFrame: G$1, isContinuationFrame: J$1 } = requireUtil$1(), { WebsocketFrameSend: V } = requireFrame(), { closeWebSocketConnection: _$1 } = requireConnection(), { PerMessageDeflate: q$1 } = requirePermessageDeflate(), x = class x$1 extends A {
			constructor(K, nA) {
				...
				SA(this, w$2, []);
				SA(this, S$1);
				this.ws = K, mA(this, S$1, nA ?? /* @__PURE__ */ new Map()), Z(this, S$1).has("permessage-deflate") && Z(this, S$1).set("permessage-deflate", new q$1(nA));
			}
			_write(K, nA, iA) {
			...
			run(K) {
				for (; Z(this, f$4);) if (Z(this, n$4) === c$5.INFO) {
					...
					if (!N(uA)) return l$1(this.ws, "Invalid opcode received"), K();
					if (RA) return l$1(this.ws, "Frame cannot be masked"), K();
					...
					if (b(Z(this, C$1).opcode)) mA(this, f$4, this.parseControlFrame(nA)), mA(this, n$4, c$5.INFO);
						...
						Z(this, S$1).get("permessage-deflate").decompress(nA, Z(this, C$1).fin, (iA, uA) => {
							...
							I(this.ws, Z(this, C$1).binaryType, Buffer.concat(Z(this, w$2))), mA(this, f$4, !0), mA(this, n$4, c$5.INFO), Z(this, w$2).length = 0, this.run(K);
						}), mA(this, f$4, !1);
						break;
					} else {
	...
	function requireWebsocket() {
		...
		z$1 = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), nA = /* @__PURE__ */ new WeakMap(), iA = /* @__PURE__ */ new WeakMap(), uA = /* @__PURE__ */ new WeakSet(), Ze = e$6(function(fA, kA) {
			this[r] = fA;
...
${p$1}`;
	...
	function requireEventsource() {
		...
		const o$6 = 3e3, N = 0, l$1 = 1, I = 2, p$1 = "anonymous", b = "use-credentials", x = class x$1 extends EventTarget {
			constructor(K, nA = {}) {
				...
				B.argumentLengthCheck(arguments, 1, iA), r || (r = !0, process.emitWarning("EventSource is experimental, expect them to change at any time.", { code: "UNDICI-ES" })), K = B.converters.USVString(K, iA, "url"), nA = B.converters.EventSourceInitDict(nA, iA, "eventSourceInitDict"), mA(this, f$4, nA.dispatcher), mA(this, n$4, {
					lastEventId: "",
		...
		V = /* @__PURE__ */ new WeakMap(), _$1 = /* @__PURE__ */ new WeakMap(), q$1 = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), Y = /* @__PURE__ */ new WeakMap(), m$3 = /* @__PURE__ */ new WeakMap(), f$4 = /* @__PURE__ */ new WeakMap(), n$4 = /* @__PURE__ */ new WeakMap(), C$1 = /* @__PURE__ */ new WeakSet(), Ue = e$6(function() {
			...
			K.processResponseEndOfBody = e$6((iA) => {
				F$3(iA) && (this.dispatchEvent(new Event("error")), this.close()), ee(this, C$1, Me).call(this);
			}, "processEventSourceEndOfBody"), K.processResponse = (iA) => {
	...
	function requireUndici() {
		...
		const { parseMIMEType: $, serializeAMimeType: K } = requireDataUrl();
		undici.parseMIMEType = $, undici.serializeAMimeType = K;
...
function ft() {
	...
	const H$3 = typeof process == "object" && process ? process : {
		stdout: null,
		stderr: null
	}, Z$1 = require$$0$3, q$1 = require$$0$2, G$1 = ht.StringDecoder, m$3 = Symbol("EOF"), d$1 = Symbol("maybeEmitEnd"), y$3 = Symbol("emittedEnd"), R$3 = Symbol("emittingEnd"), g$1 = Symbol("emittedError"), B = Symbol("closed"), Y = Symbol("read"), T$2 = Symbol("flush"), $ = Symbol("flushChunk"), f$4 = Symbol("encoding"), c$5 = Symbol("decoder"), M = Symbol("flowing"), S$1 = Symbol("paused"), b = Symbol("resume"), i$8 = Symbol("buffer"), a$11 = Symbol("pipes"), n$4 = Symbol("bufferLength"), j$2 = Symbol("bufferPush"), I = Symbol("bufferShift"), o$6 = Symbol("objectMode"), r = Symbol("destroyed"), P$1 = Symbol("error"), x = Symbol("emitData"), V = Symbol("emitEnd"), N = Symbol("emitEnd2"), p$1 = Symbol("async"), _$1 = Symbol("abort"), O$3 = Symbol("aborted"), E$2 = Symbol("signal"), w$2 = (h$1) => Promise.resolve().then(h$1), J$1 = commonjsGlobal._MP_NO_ITERATOR_SYMBOLS_ !== "1", K = J$1 && Symbol.asyncIterator || Symbol("asyncIterator not implemented"), W = J$1 && Symbol.iterator || Symbol("iterator not implemented"), k$1 = (h$1) => h$1 === "end" || h$1 === "finish" || h$1 === "prefinish", tt$1 = (h$1) => h$1 instanceof ArrayBuffer || typeof h$1 == "object" && h$1.constructor && h$1.constructor.name === "ArrayBuffer" && h$1.byteLength >= 0, et = (h$1) => !Buffer.isBuffer(h$1) && ArrayBuffer.isView(h$1);
	class z$1 {
...
while (this[_$1](this[B]()));
		...
		pipe(t$6, e$7) {
			if (this[n$4]) return;
			const i$8 = this[c$5];
			return e$7 = e$7 || {}, t$6 === I.stdout || t$6 === I.stderr ? e$7.end = false : e$7.end = e$7.end !== false, e$7.proxyErrors = !!e$7.proxyErrors, i$8 ? e$7.end && t$6.end() : (this.pipes.push(e$7.proxyErrors ? new K(this, t$6, e$7) : new U(this, t$6, e$7)), this[d$1] ? b(() => this[p$1]()) : this[p$1]()), t$6;
		}
		unpipe(t$6) {
...
function Os() {
	if (y) return G;
	y = 1;
	const ss = j$1, is = rt(), r = fs$1, es = X(), w$2 = Path, M = H(), K = p(), ts = z(), os$1 = c(), l$1 = a$7(), rs = s(), hs = a$1(), H$1$1 = Symbol("onEntry"), q$1 = Symbol("checkFs"), Y = Symbol("checkFs2"), v$2 = Symbol("pruneCache"), N = Symbol("isReusable"), d$1 = Symbol("makeFs"), U = Symbol("file"), F$1$1 = Symbol("directory"), O$3 = Symbol("link"), B = Symbol("symlink"), z$1 = Symbol("hardlink"), W = Symbol("unsupported"), j$2 = Symbol("checkPath"), b = Symbol("mkdir"), m$3 = Symbol("onError"), $ = Symbol("pending"), V$1 = Symbol("pend"), S$1 = Symbol("unpend"), P$1 = Symbol("ended"), A = Symbol("maybeClose"), x = Symbol("skip"), E$2 = Symbol("doChown"), R$3 = Symbol("uid"), _$1 = Symbol("gid"), g$1 = Symbol("checkedCwd"), X$1$1 = require$$1, J$1 = F(), C$1 = (process.env.TESTING_TAR_FAKE_PLATFORM || process.platform) === "win32", cs = 1024, as = (a$11, s$8) => {
...
var init_default = defineCommand({
	...
	async run(ctx) {
		...
		logger.info(colors.bold(`Welcome to Nuxt!`.split("").map((m$3) => `${themeColor}${m$3}`).join("")));
		...
		let templateDownloadPath = resolve$1(cwd$1, ctx.args.dir);
		logger.info(`Creating a new project in ${colors.cyan(relative(cwd$1, templateDownloadPath) || templateDownloadPath)}.`);
		...
		if (!shouldForce && existsSync(templateDownloadPath)) switch (await logger.prompt(`The directory ${colors.cyan(templateDownloadPath)} already exists. What would you like to do?`, {
			...
			case "Select different directory":
				templateDownloadPath = resolve$1(cwd$1, await logger.prompt("Please specify a different directory:", {
					type: "text",
					cancel: "reject"
				}).catch(() => process$1.exit(1)));
				break;
		...
		if (ctx.args.nightly !== void 0 && !ctx.args.offline && !ctx.args.preferOffline) {
			...
			const packageJsonPath = resolve$1(cwd$1, ctx.args.dir);
			const packageJson = await readPackageJSON(packageJsonPath);
		...
		const modulesToAdd = [];
		if (ctx.args.modules !== void 0) modulesToAdd.push(...(ctx.args.modules || "").split(",").map((module$1) => module$1.trim()).filter(Boolean));
			...
			if (await logger.prompt(`Would you like to install any of the official modules?`, {
				...
				const officialModules = response$1.modules.filter((module$1) => module$1.type === "official" && module$1.npm !== "@nuxt/devtools").filter((module$1) => !templateDeps.includes(module$1.npm));
				if (officialModules.length === 0) logger.info("All official modules are already included in this template.");
					...
					if (selectedOfficialModules === void 0) process$1.exit(1);
