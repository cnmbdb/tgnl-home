...
import { a as w } from "./use-outside-click-BHqYmLlt.js";
...
let $ = defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e2, { slots: t, attrs: l }) {
  let r = ref(null), i$1 = computed(() => i(r)), o$1 = s(), u2 = inject(H, null), n2 = ref(o$1 === true || u2 == null ? x(r.value) : u2.resolveTarget());
...
//# sourceMappingURL=portal-RXXuCQxI.js.map
