...
import { u as useUI, D as popover_default } from './ui-G7Oicn0a.mjs';
import { s, i, o as o$1, A, u as u$1, N as N$2, a as o } from './keyboard-CvjRf4Wb.mjs';
import { i as i$1, P, N, E, w, T, h as h$1 } from './focus-management-DFaZHIRF.mjs';
...
import { l, i as i$2, t } from './open-closed-Dsm1EOia.mjs';
import { n, q, N as N$1, E as E$1, d as d$1, v } from './portal-BLTG7ywv.mjs';
...
var ye = defineComponent({
  ...
  setup(d$1, { slots: P$1, attrs: s$2, expose: h$2 }) {
    ...
    let t$1 = ref(1), o$2 = ref(null), y = ref(null), v$1 = ref(null), m = ref(null), b = computed(() => i$1(f$1)), E$2 = computed(() => {
      var L, $;
      ...
      let e = E(), r = e.indexOf(o$1(o$2)), l$1 = (r + e.length - 1) % e.length, g = (r + 1) % e.length, G = e[l$1], C = e[g];
      ...
      close(e) {
        var _a;
        a.closePopover();
        (_a = (() => e ? e instanceof HTMLElement ? e : e.value instanceof HTMLElement ? o$1(e) : o$1(a.button) : o$1(a.button))()) == null ? void 0 : _a.focus();
      }
    };
    ...
    }, c = ae(), I = c == null ? void 0 : c.registerPopover, [F, w$2$1] = q(), i$3 = N$1({
    ...
    }, true), w$2(i$3.resolveContainers, (e, r) => {
      var l$1;
      a.closePopover(), w(r, h$1.Loose) || (e.preventDefault(), (l$1 = o$1(o$2)) == null || l$1.focus());
    }, computed(() => t$1.value === 0)), () => {
      let e = {
        open: t$1.value === 0,
        close: a.close
      };
      return h(Fragment, [h(w$2$1, {}, () => A({
        theirProps: {
          ...d$1,
          ...s$2
        },
  ...
  inheritAttrs: false,
  setup(d$1$1, { attrs: P$1, slots: s$2, expose: h$2 }) {
    var u$2;
    let f$1 = (u$2 = d$1$1.id) != null ? u$2 : `headlessui-popover-button-${i()}`, t$1 = U("PopoverButton"), o$2 = computed(() => i$1(t$1.button));
    h$2({
      el: t$1.button,
      $el: t$1.button
    });
    let y = ae(), v$1 = y == null ? void 0 : y.closeOthers, m = ge(), b = computed(() => m === null ? false : m.value === t$1.panelId.value), E$2 = ref(null), a = `headlessui-focus-sentinel-${i()}`;
    b.value || watchEffect(() => {
    ...
    function c(e) {
      ...
      if (b.value) {
        ...
        case o.Space:
        case o.Enter:
          e.preventDefault(), e.stopPropagation(), t$1.popoverState.value === 1 && (v$1 == null ? void 0 : v$1(t$1.buttonId.value)), t$1.togglePopover();
          break;
        case o.Escape:
    ...
    function F(e) {
      var r, l$1;
      d$1$1.disabled || (b.value ? (t$1.closePopover(), (r = o$1(t$1.button)) == null || r.focus()) : (e.preventDefault(), e.stopPropagation(), t$1.popoverState.value === 1 && (v$1 == null ? void 0 : v$1(t$1.buttonId.value)), t$1.togglePopover(), (l$1 = o$1(t$1.button)) == null || l$1.focus()));
    }
    function w$2(e) {
    ...
    return () => {
      let e = t$1.popoverState.value === 0, r = { open: e }, { ...l$1 } = d$1$1;
      return h(Fragment, [A({
        ourProps: b.value ? {
          ref: E$2,
          type: S.value,
...
defineComponent({
  ...
  setup(d$1, { attrs: P$1, slots: s$2 }) {
    let h$2 = U("PopoverOverlay"), f$1 = `headlessui-popover-overlay-${i()}`, t$1 = l(), o$2 = computed(() => t$1 !== null ? (t$1.value & i$2.Open) === i$2.Open : h$2.popoverState.value === 0);
    function y() {
      h$2.closePopover();
    }
    return () => {
...
var je = defineComponent({
  ...
  setup(d$1$1, { attrs: P$1, slots: s$2, expose: h$2 }) {
    var w$2;
    let f$1 = (w$2 = d$1$1.id) != null ? w$2 : `headlessui-popover-panel-${i()}`, { focus: t$1 } = d$1$1, o$2 = U("PopoverPanel"), y = computed(() => i$1(o$2.panel)), v$1 = `headlessui-focus-sentinel-before-${i()}`, m = `headlessui-focus-sentinel-after-${i()}`;
    h$2({
      el: o$2.panel,
      $el: o$2.panel
      ...
      (u$2 = o$1(o$2.panel)) != null && u$2.contains(i$3) || P(o$1(o$2.panel), N.First);
    });
    let b = l(), E$2 = computed(() => b !== null ? (b.value & i$2.Open) === i$2.Open : o$2.popoverState.value === 0);
    function a(i$3) {
      var p, u$2;
      switch (i$3.key) {
        case o.Escape:
    ...
    function S(i$3) {
      ...
      p && o$1(o$2.panel) && ((u$2 = o$1(o$2.panel)) != null && u$2.contains(p) || (o$2.closePopover(), ((r = (e = o$1(o$2.beforePanelSentinel)) == null ? void 0 : e.contains) != null && r.call(e, p) || (g = (l$1 = o$1(o$2.afterPanelSentinel)) == null ? void 0 : l$1.contains) != null && g.call(l$1, p)) && p.focus({ preventScroll: true })));
    }
    let c = n();
    function I() {
      ...
      function p() {
        u$1(c.value, {
          [d$1.Forwards]: () => {
            var e;
            P(i$3, N.First) === T.Error && ((e = o$1(o$2.afterPanelSentinel)) == null || e.focus());
          },
          [d$1.Backwards]: () => {
            var u$2;
            (u$2 = o$1(o$2.button)) == null || u$2.focus({ preventScroll: true });
          }
        });
      }
      p();
      ...
      function p() {
        u$1(c.value, {
          [d$1.Forwards]: () => {
            ...
            if (!u$2) return;
            let r = E(), l$1 = r.indexOf(u$2), g = r.slice(0, l$1 + 1), C = [...r.slice(l$1 + 1), ...g];
          ...
          [d$1.Backwards]: () => {
            var e;
            P(i$3, N.Previous) === T.Error && ((e = o$1(o$2.button)) == null || e.focus());
          }
        });
      }
      p();
...
defineComponent({
  ...
  setup(d$1, { attrs: P$1, slots: s$2, expose: h$2 }) {
    let f$1 = ref(null), t$1 = shallowRef([]), o$2 = computed(() => i$1(f$1)), y = v();
    h$2({
      el: f$1,
      $el: f$1
    });
    ...
    function b() {
      ...
      return (c = o$1(f$1)) != null && c.contains(S) ? true : t$1.value.some((I) => {
        var F, w$2;
...
//# sourceMappingURL=Popover-LuMswdJ3.mjs.map
