...
import { u as useUI, j as input_default } from './ui-G7Oicn0a.mjs';
...
var _sfc_main = defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    const updateInput = (value) => {
      ...
      if (modelModifiers.value.number || props.type === "number") value = looseToNumber(value);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: _ctx.type === "hidden" ? "hidden" : _ctx.ui.wrapper }, _attrs))}><input${ssrRenderAttrs(mergeProps({
    id: _ctx.inputId,
    ref: "input",
    name: _ctx.name,
    type: _ctx.type,
...
var Input_default = /* @__PURE__ */ __plugin_vue_export_helper_default(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { Input_default as default };
//# sourceMappingURL=Input-CbhZIhGI.mjs.map
