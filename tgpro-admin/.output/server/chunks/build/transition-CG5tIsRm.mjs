import { t as t$2 } from './micro-task-CYdHJ3PN.mjs';
import { t as t$1$1, o } from './active-element-history-DJ1NL7os.mjs';
import { S, i, u, A, T, o as o$1, N as N$2, a as o$2 } from './keyboard-CvjRf4Wb.mjs';
import { c as c$1$1, i as i$2, S as S$1, P, N as N$3 } from './focus-management-DFaZHIRF.mjs';
import { w as w$2, t as t$3 } from './use-outside-click-B4rja7ys.mjs';
import { f, u as u$3 } from './hidden-Bsn3DsxF.mjs';
import { s, t, i as i$1, l } from './open-closed-Dsm1EOia.mjs';
import { q, N, E, u as u$1, $, z, n, d as d$1 } from './portal-BLTG7ywv.mjs';
import { k } from './description-Y4p4EFv6.mjs';
import { defineComponent, ref, h, computed, watchEffect, provide, normalizeClass, inject, nextTick, watch, Fragment, shallowRef } from 'vue';
...
var ue = Object.assign(defineComponent({
  ...
  setup(t$5, { attrs: n$1, slots: r, expose: l$2 }) {
    ...
    let i$4 = computed(() => i$2(o$3)), e = ref(false);
    ...
    let s$2 = ref(false);
    function F(u$4) {
      u$4.key === "Tab" && (s$2.value = true, requestAnimationFrame(() => {
        s$2.value = false;
      }));
    }
    function H$1(u$4) {
...
function W$1(t$5) {
  let n$1 = ref(t$1$1.slice());
  return watch([t$5], ([r], [l$2]) => {
    l$2 === true && r === false ? t$2(() => {
      n$1.value.splice(0);
    }) : l$2 === false && r === true && (n$1.value = t$1$1.slice());
  }, { flush: "post" }), () => {
    var r;
...
function N$4(t$5, n$1) {
  for (let r of t$5) if (r.contains(n$1)) return true;
  return false;
}
function m(t$5) {
...
function w$1() {
  return t$3() ? { before({ doc: r, d: n$1, meta: c$2 }) {
    function a$2(o$3) {
    ...
    n$1.microTask(() => {
      ...
      }, true), n$1.addEventListener(r, "touchstart", (t$5) => {
...
function d(t$5, a$2, n$1) {
  ...
  return watch([t$5, a$2], ([e, m$2], [r], o$3) => {
    ...
    let f$1 = false;
    o$3(() => {
      f$1 || (a.dispatch("POP", r != null ? r : e, n$1), f$1 = true);
    });
  }, { immediate: true }), l$2;
}
var i$3 = /* @__PURE__ */ new Map(), t$1 = /* @__PURE__ */ new Map();
function E$1(d$2, f$1 = ref(true)) {
  watchEffect((o$3) => {
    var a$2;
    if (!f$1.value) return;
    let e = o$1(d$2);
...
function R$1({ type: o$3, enabled: r, element: e, onUpdate: i$4 }) {
  let a$2 = y();
  function t$5(...n$1) {
    i$4 == null ? void 0 : i$4(...n$1), a$2(...n$1);
  }
  provide(u$2, t$5);
}
...
var A$1 = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Ye = defineComponent({
  ...
  emits: { close: (t$5) => true },
  setup(t$5, { emit: i$4, attrs: l$2, slots: p, expose: s$2 }) {
    var q$1, W$2;
    let n$1 = (q$1 = t$5.id) != null ? q$1 : `headlessui-dialog-${i()}`, u$4 = ref(false);
    let r = false, g$1 = computed(() => t$5.role === "dialog" || t$5.role === "alertdialog" ? t$5.role : (r || (r = true, console.warn(`Invalid role [${g$1}] passed to <Dialog />. Only \`dialog\` and and \`alertdialog\` are supported. Using \`dialog\` instead.`)), "dialog")), D = ref(0), S$2 = l(), R$2 = computed(() => t$5.open === A$1 && S$2 !== null ? (S$2.value & i$1.Open) === i$1.Open : t$5.open), m$2 = ref(null), E$2 = computed(() => i$2(m$2));
    if (s$2({
      el: m$2,
      $el: m$2
    ...
    let c$2 = computed(() => u$4.value && R$2.value ? 0 : 1), k$1 = computed(() => c$2.value === 0), w$2$1 = computed(() => D.value > 1), N$5 = inject(H, null) !== null, [Q$1, X] = q(), { resolveContainers: B$1, mainTreeNodeRef: K$1, MainTreeNode: Z } = N({
      portals: Q$1,
      defaultContainers: [computed(() => {
        var e;
        return (e = h$1.panelRef.value) != null ? e : m$2.value;
      })]
    }), ee = computed(() => w$2$1.value ? "parent" : "leaf"), U = computed(() => S$2 !== null ? (S$2.value & i$1.Closing) === i$1.Closing : false), te = computed(() => N$5 || U.value ? false : k$1.value);
    E$1(computed(() => {
      var e, a$2, d$2;
      return (d$2 = Array.from((a$2 = (e = E$2.value) == null ? void 0 : e.querySelectorAll("body > *")) != null ? a$2 : []).find((f$1) => f$1.id === "headlessui-portal-root" ? false : f$1.contains(o$1(K$1)) && f$1 instanceof HTMLElement)) != null ? d$2 : null;
    }), te);
    let ae = computed(() => w$2$1.value ? true : k$1.value);
    E$1(computed(() => {
      var e, a$2, d$2;
    ...
    }, computed(() => !(!k$1.value || w$2$1.value)));
    let ie = computed(() => !(w$2$1.value || c$2.value !== 0));
    ...
    return d(E$2, computed(() => !(U.value || c$2.value !== 0 || N$5)), (e) => {
      ...
      let { open: e, initialFocus: a$2, ...d$2 } = t$5, f$1 = {
        ...
        id: n$1,
        role: g$1.value,
        "aria-modal": c$2.value === 0 ? true : void 0,
        "aria-labelledby": M.value,
        "aria-describedby": re.value
      }, L$1 = { open: c$2.value === 0 };
      return h(u$1, { force: true }, () => [h($, () => h(z, { target: m$2.value }, () => h(u$1, { force: false }, () => h(ue, {
        initialFocus: a$2,
        containers: B$1,
...
function Q(e) {
  ...
  function s$2(n$1, r = S.Hidden) {
    ...
    }), !L(t$5) && a$2.value && (e == null ? void 0 : e()));
  }
  function h$1(n$1) {
...
var W = N$2.RenderStrategy, he = defineComponent({
  props: {
    as: {
      type: [Object, String],
      default: "div"
  ...
  setup(e, { emit: t$5, attrs: a$2, slots: s$2, expose: h$1 }) {
    ...
    let { show: v, appear: A$3 } = Te(), { register: D, unregister: H$1 } = ge(), i$4 = ref(v.value ? "visible" : "hidden"), c$2 = i(), P$1 = Q(() => {
      i$4.value !== "hidden" && (i$4.value = "hidden", H$1(c$2), S$2());
    });
    watchEffect(() => {
    ...
    return provide(N$1, P$1), t(computed(() => u(i$4.value, {
      ...
      return A({
        theirProps: {
          ...U,
          ...A$3.value && v.value && c$1$1.isServer ? { class: normalizeClass([
            a$2.class,
            U.class,
            ...j,
            ...M
  ...
  setup(e, { emit: t$5, attrs: a$2, slots: s$2 }) {
    ...
    watchEffect(() => {
      if (![true, false].includes(n$1.value)) throw new Error('A <Transition /> is used but it is missing a `:show="true | false"` prop.');
    });
...
//# sourceMappingURL=transition-CG5tIsRm.mjs.map
