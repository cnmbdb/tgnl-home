...
var FormException = class FormException2 extends Error {
  constructor(message) {
    super(message);
    this.message = message;
    Object.setPrototypeOf(this, FormException2.prototype);
  }
};
var _sfc_main = defineComponent({
  ...
  setup(props, { expose, emit }) {
    ...
    async function onSubmit(payload) {
      ...
      const event = payload;
      try {
        if ((_a = props.validateOn) == null ? void 0 : _a.includes("submit")) await validate();
...
//# sourceMappingURL=Form-Da8A1NFL.mjs.map
