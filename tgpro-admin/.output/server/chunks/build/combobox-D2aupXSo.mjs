...
import { t as t$1$1, o as o$2 } from './active-element-history-DJ1NL7os.mjs';
import { i, o as o$1, A, T, u, E, N, a as o } from './keyboard-CvjRf4Wb.mjs';
import { i as i$1, O } from './focus-management-DFaZHIRF.mjs';
import { w as w$2, n } from './use-outside-click-B4rja7ys.mjs';
import { s } from './use-resolve-button-type-eioNRL5V.mjs';
import { u as u$1, i as i$1$1, c, f as f$1 } from './calculate-active-index-B5ynhl2N.mjs';
import { f, u as u$2 } from './hidden-Bsn3DsxF.mjs';
import { l, i as i$2, t as t$1 } from './open-closed-Dsm1EOia.mjs';
...
var ie = Symbol("VirtualContext"), Ae = defineComponent({
  ...
  setup(a, { slots: h$1, attrs: r, emit: y }) {
    ...
    function w$1(t$3 = (n$2) => n$2) {
      let n$1 = d$1.value !== null ? v.value[d$1.value] : null, s$1 = t$3(v.value.slice()), b = s$1.length > 0 && s$1[0].dataRef.order.value !== null ? s$1.sort((C, A$1) => C.dataRef.order.value - A$1.dataRef.order.value) : O(s$1, (C) => o$1(C.dataRef.domRef)), O$1 = n$1 ? b.indexOf(n$1) : null;
      return O$1 === -1 && (O$1 = null), {
        options: b,
        activeOptionIndex: O$1
      };
    }
    let M = computed(() => a.multiple ? 1 : 0), $ = computed(() => a.nullable), [B, p] = d(computed(() => a.modelValue), (t$3) => y("update:modelValue", t$3), computed(() => a.defaultValue)), R = computed(() => B.value === void 0 ? u(M.value, {
      [1]: [],
      [0]: void 0
    ...
    let l$1 = {
      ...
      optionsPropsRef: S,
      closeCombobox() {
        E$1.value = false, !a.disabled && o$3.value !== 1 && (o$3.value = 1, d$1.value = null);
      },
      openCombobox() {
        if (E$1.value = true, !a.disabled && o$3.value !== 0) {
          if (l$1.value.value) {
      ...
      registerOption(t$3, n$1) {
        ...
        d$1.value === null && l$1.isSelected(n$1.value.value) && (b.activeOptionIndex = b.options.indexOf(s$1)), v.value = b.options, d$1.value = b.activeOptionIndex, D.value = 2, b.options.some((O$1) => !o$1(O$1.dataRef.domRef)) && (i$5 = requestAnimationFrame(() => {
          let O$1 = w$1();
          v.value = O$1.options, d$1.value = O$1.activeOptionIndex;
        }));
      },
      unregisterOption(t$3, n$1) {
        if (V !== null && cancelAnimationFrame(V), n$1 && (E$1.value = true), l$1.virtual.value) {
    ...
    w$2([
      ...
      c$1,
      f$2
    ], () => l$1.closeCombobox(), computed(() => o$3.value === 0)), provide(ne, l$1), t$1(computed(() => u(o$3.value, {
      [0]: i$2.Open,
      [1]: i$2.Closed
    })));
    computed(() => {
      var t$3;
      return (t$3 = o$1(e$1)) == null ? void 0 : t$3.closest("form");
    });
    return () => {
      var C, A$1, j;
...
defineComponent({
  ...
  setup(a, { attrs: h$1, slots: r }) {
    ...
    function u$3() {
      var c$1;
      (c$1 = o$1(o$3.inputRef)) == null || c$1.focus({ preventScroll: true });
    }
    return () => {
      let c$1 = {
...
var nt = defineComponent({
  ...
  setup(a, { attrs: h$1, slots: r, expose: y }) {
    ...
    function e$1(v) {
      u$3.disabled.value || (u$3.comboboxState.value === 0 ? u$3.closeCombobox() : (v.preventDefault(), u$3.openCombobox()), nextTick(() => {
        var d$1;
        return (d$1 = o$1(u$3.inputRef)) == null ? void 0 : d$1.focus({ preventScroll: true });
      }));
    }
    function c$1(v) {
      switch (v.key) {
        case o.ArrowDown:
          v.preventDefault(), v.stopPropagation(), u$3.comboboxState.value === 1 && u$3.openCombobox(), nextTick(() => {
            var d$1;
            return (d$1 = u$3.inputRef.value) == null ? void 0 : d$1.focus({ preventScroll: true });
          });
          return;
        case o.ArrowUp:
          v.preventDefault(), v.stopPropagation(), u$3.comboboxState.value === 1 && (u$3.openCombobox(), nextTick(() => {
    ...
    return () => {
      ...
      return A({
        ourProps: {
          ...
          "aria-controls": (E$1 = o$1(u$3.optionsRef)) == null ? void 0 : E$1.id,
          "aria-expanded": u$3.comboboxState.value === 0,
          "aria-labelledby": u$3.labelRef.value ? [(w$1 = o$1(u$3.labelRef)) == null ? void 0 : w$1.id, o$3].join(" ") : void 0,
          disabled: u$3.disabled.value === true ? true : void 0,
          onKeydown: c$1,
          onClick: e$1
        },
        theirProps: d$1,
  ...
  setup(a, { emit: h$1, attrs: r, slots: y, expose: o$3 }) {
    ...
    function S() {
      e$1.change(null);
      let i$5 = o$1(e$1.optionsRef);
      i$5 && (i$5.scrollTop = 0), e$1.goToOption(c.Nothing);
    }
    computed(() => {
      var I;
      let i$5 = e$1.value.value;
      return o$1(e$1.inputRef) ? typeof a.displayValue != "undefined" && i$5 !== void 0 ? (I = a.displayValue(i$5)) != null ? I : "" : typeof i$5 == "string" ? i$5 : "" : "";
    });
    let d$1 = ref(false);
    function D() {
      d$1.value = true;
    ...
    function M(i$5) {
      switch (w$1(() => {
        ...
        case o.Enter:
          if (e$1.comboboxState.value !== 0 || d$1.value) return;
          ...
          break;
        case o.ArrowDown:
          return i$5.preventDefault(), i$5.stopPropagation(), u(e$1.comboboxState.value, {
        ...
        case o.Home:
          ...
          return i$5.preventDefault(), i$5.stopPropagation(), e$1.goToOption(c.First);
        case o.PageUp:
          return i$5.preventDefault(), i$5.stopPropagation(), e$1.goToOption(c.First);
        case o.End:
          if (i$5.shiftKey) break;
          return i$5.preventDefault(), i$5.stopPropagation(), e$1.goToOption(c.Last);
        case o.PageDown:
          return i$5.preventDefault(), i$5.stopPropagation(), e$1.goToOption(c.Last);
        case o.Escape:
          if (e$1.comboboxState.value !== 0) return;
    ...
    function B(i$5) {
      var T$1, l$1, g$1;
      let I = (T$1 = i$5.relatedTarget) != null ? T$1 : t$1$1.find((t$3) => t$3 !== i$5.currentTarget);
      if (!((l$1 = o$1(e$1.optionsRef)) != null && l$1.contains(I)) && !((g$1 = o$1(e$1.buttonRef)) != null && g$1.contains(I)) && e$1.comboboxState.value === 0) return i$5.preventDefault(), e$1.mode.value === 0 && (e$1.nullable.value && e$1.value.value === null ? S() : e$1.activationTrigger.value !== 1 && e$1.selectActiveOption()), e$1.closeCombobox();
    }
    function p(i$5) {
      var T$1, l$1, g$1;
      let I = (T$1 = i$5.relatedTarget) != null ? T$1 : t$1$1.find((t$3) => t$3 !== i$5.currentTarget);
      (l$1 = o$1(e$1.buttonRef)) != null && l$1.contains(I) || (g$1 = o$1(e$1.optionsRef)) != null && g$1.contains(I) || e$1.disabled.value || e$1.immediate.value && e$1.comboboxState.value !== 0 && (e$1.openCombobox(), o$2().nextFrame(() => {
    ...
    return () => {
      ...
      return A({
        ourProps: {
          ...
          "aria-labelledby": (C = (b = o$1(e$1.labelRef)) == null ? void 0 : b.id) != null ? C : (O$1 = o$1(e$1.buttonRef)) == null ? void 0 : O$1.id,
  ...
  setup(a, { attrs: h$1, slots: r, expose: y }) {
    ...
    i$1$1({
      container: computed(() => o$1(o$3.optionsRef)),
    ...
    return () => {
      ...
      return A({
        ourProps: {
          "aria-labelledby": (w$1 = (D = o$1(o$3.labelRef)) == null ? void 0 : D.id) != null ? w$1 : (E$1 = o$1(o$3.buttonRef)) == null ? void 0 : E$1.id,
          id: u$3,
          ref: o$3.optionsRef,
          role: "listbox",
          "aria-multiselectable": o$3.mode.value === 1 ? true : void 0,
          onMousedown: f$2
        },
        theirProps: T(a, ["hold"]),
        slot: S,
  ...
  setup(a, { slots: h$1, attrs: r, expose: y }) {
    ...
    let f$2 = computed(() => {
      var p;
      return o$3.virtual.value ? o$3.activeOptionIndex.value === o$3.calculateIndex(a.value) : o$3.activeOptionIndex.value === null ? false : ((p = o$3.options.value[o$3.activeOptionIndex.value]) == null ? void 0 : p.id) === u$3;
    ...
    watchEffect(() => {
      let p = o$1(e$1);
      p && (v == null ? void 0 : v.value.measureElement(p));
    }), watchEffect(() => {
      o$3.comboboxState.value === 0 && f$2.value && (o$3.virtual.value || o$3.activationTrigger.value !== 0 && nextTick(() => {
        var p, R;
        return (R = (p = o$1(e$1)) == null ? void 0 : p.scrollIntoView) == null ? void 0 : R.call(p, { block: "nearest" });
      }));
    });
    function D(p) {
      p.preventDefault(), p.button === g.Left && (c$1.value || (o$3.selectOption(u$3), n() || requestAnimationFrame(() => {
        var R;
        return (R = o$1(o$3.inputRef)) == null ? void 0 : R.focus({ preventScroll: true });
...
//# sourceMappingURL=combobox-D2aupXSo.mjs.map
