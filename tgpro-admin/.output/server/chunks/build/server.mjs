...
import { defineComponent, useId, createApp, createElementBlock, shallowRef, h, resolveComponent, computed, toValue, getCurrentInstance, onServerPrefetch, toRef, isRef, ref, hasInjectionContext, inject, provide, onErrorCaptured, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, withCtx, getCurrentScope, nextTick, Suspense, Fragment, cloneVNode, useSSRContext } from 'vue';
import { v as defuFn, w as hasProtocol, x as isScriptProtocol, y as joinURL, z as parseQuery, i as defu, A as destr, B as klona, C as createDefu, c as createError, D as createHooks, E as executeAsync, F as withQuery, G as sanitizeStatusCode, H as getRequestHeader, j as isEqual, I as toRouteMatcher, J as createRouter$1, K as getContext, L as withTrailingSlash, M as withoutTrailingSlash, s as setCookie, N as getCookie, O as deleteCookie, $ as $fetch$1, P as baseURL } from '../nitro/nitro.mjs';
...
var virtual_nuxt__2FUsers_2Fhf_mac_2FDownloads_2Ftgpro_admin_2F_nuxt_2Froutes_default = [
	{
		...
		component: () => import('./pages-9WyMgO--.mjs')
	},
	{
		name: "dashboard",
		path: "/dashboard",
		meta: dashboard_default || {},
		component: () => import('./dashboard-C3n27BAI.mjs')
	},
	{
		name: "bots",
		path: "/bots",
		...
		component: () => import('./bots-BnAOkfjA.mjs')
	},
	{
		name: "users",
		path: "/users",
		...
		component: () => import('./users-FX6bDaAf.mjs')
	},
	{
		name: "orders",
		path: "/orders",
		meta: { "middleware": "auth" },
		component: () => import('./orders-PpKj65Nq.mjs')
	},
	{
		name: "license",
		path: "/license",
		...
		component: () => import('./license-Cfm2MCeS.mjs')
	},
	{
		name: "analytics",
		path: "/analytics",
		meta: { "middleware": "auth" },
		component: () => import('./analytics-RnSPW9BI.mjs')
	},
	{
		name: "dashboard-backup",
		path: "/dashboard-backup",
		meta: dashboard_backup_default || {},
		component: () => import('./dashboard-backup-C0wWEG-8.mjs')
	},
	{
		name: "development",
		path: "/development",
		meta: development_default || {},
		component: () => import('./development-APhzOOll.mjs')
	},
	{
		name: "bot-commands",
		path: "/bot-commands",
		meta: { "middleware": "auth" },
		component: () => import('./bot-commands-DzTujP91.mjs')
	},
	{
		name: "keyword-replies",
		path: "/keyword-replies",
		meta: { "middleware": "auth" },
		component: () => import('./keyword-replies-DIfUHKLE.mjs')
	},
	{
		name: "inline-keyboards",
		path: "/inline-keyboards",
		meta: { "middleware": "auth" },
		component: () => import('./inline-keyboards-BfKJS_G3.mjs')
	},
	{
		name: "keyboard-buttons",
		path: "/keyboard-buttons",
		meta: { "middleware": "auth" },
		component: () => import('./keyboard-buttons-BCfnWmSm.mjs')
	},
	{
		name: "development-contribution-guide",
		path: "/development/contribution-guide",
		meta: contribution_guide_default || {},
		component: () => import('./contribution-guide-Cw-pZhM7.mjs')
	}
];
...
const namedMiddleware = { auth: () => import('./auth-Dd1UmxXA.mjs') };
...
var Accordion_default = defineAsyncComponent(() => import('./Accordion--y63Onus.mjs').then((r) => r["default"] || r.default || r));
var Alert_default = defineAsyncComponent(() => import('./Alert-BxHqwDvj.mjs').then((r) => r["default"] || r.default || r));
var Avatar_default = defineAsyncComponent(() => import('./Avatar-RiJ55zLR.mjs').then((r) => r["default"] || r.default || r));
var AvatarGroup_default = defineAsyncComponent(() => import('./AvatarGroup-B678Y04S.mjs').then((r) => r["default"] || r.default || r));
var Badge_default = defineAsyncComponent(() => import('./Badge-Bb9IcqQP.mjs').then((r) => r["default"] || r.default || r));
var Button_default = defineAsyncComponent(() => import('./Button-B1clF2nP.mjs').then((r) => r["default"] || r.default || r));
var ButtonGroup_default = defineAsyncComponent(() => import('./ButtonGroup-CEm0fqt9.mjs').then((r) => r["default"] || r.default || r));
var Carousel_default = defineAsyncComponent(() => import('./Carousel-DQaGlC9C.mjs').then((r) => r["default"] || r.default || r));
var Chip_default = defineAsyncComponent(() => import('./Chip-CwJm2tnn.mjs').then((r) => r["default"] || r.default || r));
var Dropdown_default = defineAsyncComponent(() => import('./Dropdown-YMSaHnp6.mjs').then((r) => r["default"] || r.default || r));
var Icon_default = defineAsyncComponent(() => import('./Icon-BQxbVddL.mjs').then((r) => r["default"] || r.default || r));
var Kbd_default = defineAsyncComponent(() => import('./Kbd-B6q0WgYi.mjs').then((r) => r["default"] || r.default || r));
var Link_default = defineAsyncComponent(() => import('./Link-CL8ivRbg.mjs').then((r) => r["default"] || r.default || r));
var Meter_default = defineAsyncComponent(() => import('./Meter-DRL7lJFj.mjs').then((r) => r["default"] || r.default || r));
var MeterGroup_default = defineAsyncComponent(() => import('./MeterGroup-BV6LwsS_.mjs').then((r) => r["default"] || r.default || r));
var Progress_default = defineAsyncComponent(() => import('./Progress-CDhee4s0.mjs').then((r) => r["default"] || r.default || r));
var Checkbox_default = defineAsyncComponent(() => import('./Checkbox-DU9jOqk6.mjs').then((r) => r["default"] || r.default || r));
var Form_default = defineAsyncComponent(() => import('./Form-Da8A1NFL.mjs').then((r) => r["default"] || r.default || r));
var FormGroup_default = defineAsyncComponent(() => import('./FormGroup-C-BMHVTQ.mjs').then((r) => r["default"] || r.default || r));
var Input_default = defineAsyncComponent(() => import('./Input-CbhZIhGI.mjs').then((r) => r["default"] || r.default || r));
var InputMenu_default = defineAsyncComponent(() => import('./InputMenu-CV105MzK.mjs').then((r) => r["default"] || r.default || r));
var Radio_default = defineAsyncComponent(() => import('./Radio-aeVn_7jN.mjs').then((r) => r["default"] || r.default || r));
var RadioGroup_default = defineAsyncComponent(() => import('./RadioGroup-DnPNvloc.mjs').then((r) => r["default"] || r.default || r));
var Range_default = defineAsyncComponent(() => import('./Range-DmYjY98D.mjs').then((r) => r["default"] || r.default || r));
var Select_default = defineAsyncComponent(() => import('./Select-Cx-ISQOC.mjs').then((r) => r["default"] || r.default || r));
var SelectMenu_default = defineAsyncComponent(() => import('./SelectMenu-D72j-RJr.mjs').then((r) => r["default"] || r.default || r));
var Textarea_default = defineAsyncComponent(() => import('./Textarea-ClW9ULmm.mjs').then((r) => r["default"] || r.default || r));
var Toggle_default = defineAsyncComponent(() => import('./Toggle-D7wSDC1Y.mjs').then((r) => r["default"] || r.default || r));
var Table_default = defineAsyncComponent(() => import('./Table-4-cEq18p.mjs').then((r) => r["default"] || r.default || r));
var Card_default = defineAsyncComponent(() => import('./Card-CV7B2HPk.mjs').then((r) => r["default"] || r.default || r));
var Container_default = defineAsyncComponent(() => import('./Container-CU98n4RS.mjs').then((r) => r["default"] || r.default || r));
var Divider_default = defineAsyncComponent(() => import('./Divider-Ddhjrdke.mjs').then((r) => r["default"] || r.default || r));
var Skeleton_default = defineAsyncComponent(() => import('./Skeleton-DTw_175A.mjs').then((r) => r["default"] || r.default || r));
var Breadcrumb_default = defineAsyncComponent(() => import('./Breadcrumb-Cag7lz-w.mjs').then((r) => r["default"] || r.default || r));
var CommandPalette_default = defineAsyncComponent(() => import('./CommandPalette-noZ4qn7j.mjs').then((r) => r["default"] || r.default || r));
var CommandPaletteGroup_default = defineAsyncComponent(() => import('./CommandPaletteGroup-Dpky3S1g.mjs').then((r) => r["default"] || r.default || r));
var HorizontalNavigation_default = defineAsyncComponent(() => import('./HorizontalNavigation-CzaVZKrM.mjs').then((r) => r["default"] || r.default || r));
var Pagination_default = defineAsyncComponent(() => import('./Pagination-DF7FzyKw.mjs').then((r) => r["default"] || r.default || r));
var Tabs_default = defineAsyncComponent(() => import('./Tabs-BA-VGK81.mjs').then((r) => r["default"] || r.default || r));
var VerticalNavigation_default = defineAsyncComponent(() => import('./VerticalNavigation-DjrjXQl5.mjs').then((r) => r["default"] || r.default || r));
var ContextMenu_default = defineAsyncComponent(() => import('./ContextMenu-CjvrV2EK.mjs').then((r) => r["default"] || r.default || r));
var Modal_default = defineAsyncComponent(() => import('./Modal-BbhoxMMu.mjs').then((r) => r["default"] || r.default || r));
var server_placeholder_default = defineAsyncComponent(() => Promise.resolve().then(function () { return serverPlaceholderBOvhNubJ; }).then((r) => r["default"] || r.default || r));
var Notification_default = defineAsyncComponent(() => import('./Notification-DJwR7WOQ.mjs').then((r) => r["default"] || r.default || r));
var Notifications_default = defineAsyncComponent(() => import('./Notifications-D82kc3kv.mjs').then((r) => r["default"] || r.default || r));
var Popover_default = defineAsyncComponent(() => import('./Popover-LuMswdJ3.mjs').then((r) => r["default"] || r.default || r));
var Slideover_default = defineAsyncComponent(() => import('./Slideover-c0hApqtk.mjs').then((r) => r["default"] || r.default || r));
var server_placeholder_default$1 = defineAsyncComponent(() => Promise.resolve().then(function () { return serverPlaceholderBOvhNubJ; }).then((r) => r["default"] || r.default || r));
var Tooltip_default = defineAsyncComponent(() => import('./Tooltip-eZfphyc4.mjs').then((r) => r["default"] || r.default || r));
var components_default = defineAsyncComponent(() => import('./components-CqoEyeNn.mjs').then((r) => r["default"] || r.default || r));
...
var virtual_nuxt__2FUsers_2Fhf_mac_2FDownloads_2Ftgpro_admin_2F_nuxt_2Flayouts_default = { default: defineAsyncComponent(() => import('./default-Bel6th_c.mjs').then((m) => m.default || m)) };
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('./error-404-DNC3tuwi.mjs'));
		const _Error = defineAsyncComponent(() => import('./error-500-BUETGIOb.mjs'));
...
const serverPlaceholderBOvhNubJ = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: server_placeholder_default$2
