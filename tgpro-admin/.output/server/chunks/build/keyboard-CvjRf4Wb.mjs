...
function A({ visible: r$1 = true, features: t = 0, ourProps: e$1, theirProps: o$3, ...i$1 }) {
  var a;
...
function y({ props: r$1, attrs: t, slots: e$1, slot: o$3, name: i$1 }) {
  ...
  if (o$3) {
    let u$1 = false, c = [];
    for (let [p, f] of Object.entries(o$3)) typeof f == "boolean" && (u$1 = true), f === true && c.push(p);
...
`));
      let p = j((h$1 = u$1.props) != null ? h$1 : {}, l, d), f = cloneVNode(u$1, p, true);
...
function j(...r$1) {
  ...
  let t = {}, e$1 = {};
  for (let i$1 of r$1) for (let n$1 in i$1) n$1.startsWith("on") && typeof i$1[n$1] == "function" ? ((_a = e$1[n$1]) != null ? _a : e$1[n$1] = [], e$1[n$1].push(i$1[n$1])) : t[n$1] = i$1[n$1];
...
function v(r$1) {
  return r$1 == null ? false : typeof r$1.type == "string" || typeof r$1.type == "object" || typeof r$1.type == "function";
}
...
//# sourceMappingURL=keyboard-CvjRf4Wb.mjs.map
