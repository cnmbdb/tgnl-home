...
var _sfc_main = {
  ...
  setup(__props) {
    ...
    const checkForUpdates = async () => {
      checking.value = true;
      try {
        const result = await (await fetch("/api/system/version-check")).json();
        if (result.success && result.data) {
          ...
          if (data.updateInfo) versionInfo.value.updateInfo = {
        ...
        } else console.error("\u7248\u672C\u68C0\u67E5API\u8FD4\u56DE\u9519\u8BEF:", result.error);
      } catch (error) {
    ...
    const executeAllSteps = async () => {
      for (const stepName of [
        ...
        if (independentSteps.value[stepName].status === "error") break;
      }
    };
    const openGitHubRepo = () => {
      (void 0).open("https://github.com/cnmbdb/hf-tgpro-admin", "_blank");
    };
    const getStepStatusText = (step, stepName) => {
      if (stepStatusData.value[stepName]) {
        if (stepStatusData.value[stepName].isCompleted) return "\u5DF2\u5B8C\u6210";
    ...
    const getStepBadgeColor = (step, stepName) => {
      if (stepStatusData.value[stepName]) {
        if (stepStatusData.value[stepName].isCompleted) return "green";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(versionInfo).hasUpdate) _push(`<div class="text-center"><div class="text-3xl font-bold text-[#00dc82]">\u6700\u65B0\u7248\u672C</div><div class="text-sm text-[#9ca3af]">\u7CFB\u7EDF\u5DF2\u662F\u6700\u65B0\u7248\u672C</div></div>`);
      else _push(`<div class="text-center"><div class="text-3xl font-bold text-orange-400">\u6709\u65B0\u7248\u672C</div><div class="text-sm text-[#9ca3af]">v${ssrInterpolate(formatVersionDisplay(unref(versionInfo).latestVersion))} \u53EF\u7528</div></div>`);
      ...
      if (unref(versionInfo).hasUpdate) _push(`<div class="flex justify-between"><span class="text-[#9ca3af]">\u66F4\u65B0\u5927\u5C0F</span><span class="text-white">${ssrInterpolate(formatFileSize((_a = unref(versionInfo).updateInfo) == null ? void 0 : _a.size))}</span></div>`);
      else _push(`<!---->`);
      _push(`</div>`);
      if (unref(updateProgress) > 0) _push(`<div class="w-full bg-[#2a2a2b] rounded-full h-2"><div class="bg-[#00dc82] h-2 rounded-full transition-all duration-300" style="${ssrRenderStyle({ width: `${unref(updateProgress)}%` })}"></div></div>`);
      else _push(`<!---->`);
      ...
      if (unref(independentSteps).download.status === "completed") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-check",
        class: "w-5 h-5 text-green-400"
      }, null, _parent));
      else if (unref(independentSteps).download.status === "error") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-x-mark",
        class: "w-5 h-5 text-red-400"
      }, null, _parent));
      else if (unref(independentSteps).download.status === "in_progress") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-arrow-path",
        class: "w-5 h-5 text-blue-400 animate-spin"
      }, null, _parent));
      else _push(`<span class="text-sm font-medium text-gray-400">1</span>`);
      ...
      if (unref(independentSteps).download.status === "in_progress" && unref(independentSteps).download.progress !== void 0) {
        ...
        if (unref(independentSteps).download.logs && unref(independentSteps).download.logs.length > 0) _push(`<span>${ssrInterpolate(((_c = (_b = unref(independentSteps).download.logs) == null ? void 0 : _b.at(-1)) == null ? void 0 : _c.message) || "\u4E0B\u8F7D\u4E2D...")}</span>`);
        else _push(`<!---->`);
        _push(`</div></div>`);
      } else _push(`<!---->`);
      ...
      _push(ssrRenderComponent(_component_UBadge, {
        ...
        default: withCtx((_, _push$1, _parent$1, _scopeId) => {
          if (_push$1) _push$1(`${ssrInterpolate(getStepStatusText(unref(independentSteps).download, "download"))}`);
          else return [createTextVNode(toDisplayString(getStepStatusText(unref(independentSteps).download, "download")), 1)];
        }),
        _: 1
      }, _parent));
      _push(ssrRenderComponent(_component_UButton, {
      ...
      if (unref(independentSteps).extract.status === "completed") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-check",
        class: "w-5 h-5 text-green-400"
      }, null, _parent));
      else if (unref(independentSteps).extract.status === "error") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-x-mark",
        class: "w-5 h-5 text-red-400"
      }, null, _parent));
      else if (unref(independentSteps).extract.status === "in_progress") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-arrow-path",
        class: "w-5 h-5 text-blue-400 animate-spin"
      }, null, _parent));
      else _push(`<span class="text-sm font-medium text-gray-400">2</span>`);
      ...
      _push(ssrRenderComponent(_component_UBadge, {
        ...
        default: withCtx((_, _push$1, _parent$1, _scopeId) => {
          if (_push$1) _push$1(`${ssrInterpolate(getStepStatusText(unref(independentSteps).extract, "extract"))}`);
          else return [createTextVNode(toDisplayString(getStepStatusText(unref(independentSteps).extract, "extract")), 1)];
        }),
        _: 1
      }, _parent));
      _push(ssrRenderComponent(_component_UButton, {
        ...
        default: withCtx((_, _push$1, _parent$1, _scopeId) => {
          if (_push$1) {
            ...
            _push$1(` ${ssrInterpolate(unref(stepStatusData).extract.isCompleted ? "\u5DF2\u5B8C\u6210" : "\u5F00\u59CB\u89E3\u538B")}`);
          } else return [createVNode(_component_UIcon, {
            name: unref(stepStatusData).extract.isCompleted ? "i-heroicons-check" : "i-heroicons-archive-box-arrow-down",
            class: "w-4 h-4 mr-2"
          }, null, 8, ["name"]), createTextVNode(" " + toDisplayString(unref(stepStatusData).extract.isCompleted ? "\u5DF2\u5B8C\u6210" : "\u5F00\u59CB\u89E3\u538B"), 1)];
        }),
        _: 1
      }, _parent));
      _push(`</div></div><div class="flex items-center justify-between p-4 bg-[#0c0c0d] border border-[#2a2a2b] rounded-lg"><div class="flex items-center space-x-4"><div class="w-10 h-10 bg-[#1a1a1b] border border-[#2a2a2b] rounded-lg flex items-center justify-center">`);
      if (unref(independentSteps).backup.status === "completed") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-check",
        class: "w-5 h-5 text-green-400"
      }, null, _parent));
      else if (unref(independentSteps).backup.status === "error") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-x-mark",
        class: "w-5 h-5 text-red-400"
      }, null, _parent));
      else if (unref(independentSteps).backup.status === "in_progress") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-arrow-path",
        class: "w-5 h-5 text-blue-400 animate-spin"
      }, null, _parent));
      else _push(`<span class="text-sm font-medium text-gray-400">3</span>`);
      ...
      _push(ssrRenderComponent(_component_UBadge, {
        ...
        default: withCtx((_, _push$1, _parent$1, _scopeId) => {
          if (_push$1) _push$1(`${ssrInterpolate(getStepStatusText(unref(independentSteps).backup, "backup"))}`);
          else return [createTextVNode(toDisplayString(getStepStatusText(unref(independentSteps).backup, "backup")), 1)];
        }),
        _: 1
      }, _parent));
      _push(ssrRenderComponent(_component_UButton, {
        ...
        default: withCtx((_, _push$1, _parent$1, _scopeId) => {
          if (_push$1) {
            ...
            _push$1(` ${ssrInterpolate(unref(stepStatusData).backup.isCompleted ? "\u5DF2\u5B8C\u6210" : "\u5F00\u59CB\u5907\u4EFD")}`);
          } else return [createVNode(_component_UIcon, {
            name: "i-heroicons-shield-check",
            class: "w-4 h-4 mr-2"
      ...
      _push(`</div></div><div class="flex items-center justify-between p-4 bg-[#0c0c0d] border border-[#2a2a2b] rounded-lg"><div class="flex items-center space-x-4"><div class="w-10 h-10 bg-[#1a1a1b] border border-[#2a2a2b] rounded-lg flex items-center justify-center">`);
      if (unref(independentSteps).apply.status === "completed") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-check",
        class: "w-5 h-5 text-green-400"
      }, null, _parent));
      else if (unref(independentSteps).apply.status === "error") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-x-mark",
        class: "w-5 h-5 text-red-400"
      }, null, _parent));
      else if (unref(independentSteps).apply.status === "in_progress") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-arrow-path",
        class: "w-5 h-5 text-blue-400 animate-spin"
      }, null, _parent));
      else _push(`<span class="text-sm font-medium text-gray-400">4</span>`);
      ...
      _push(ssrRenderComponent(_component_UBadge, {
        ...
        default: withCtx((_, _push$1, _parent$1, _scopeId) => {
          if (_push$1) _push$1(`${ssrInterpolate(getStepStatusText(unref(independentSteps).apply, "apply"))}`);
          else return [createTextVNode(toDisplayString(getStepStatusText(unref(independentSteps).apply, "apply")), 1)];
        }),
        _: 1
      }, _parent));
      _push(ssrRenderComponent(_component_UButton, {
        ...
        default: withCtx((_, _push$1, _parent$1, _scopeId) => {
          if (_push$1) {
            ...
            _push$1(` ${ssrInterpolate(unref(stepStatusData).apply.isCompleted ? "\u5DF2\u5B8C\u6210" : "\u5F00\u59CB\u5E94\u7528")}`);
          } else return [createVNode(_component_UIcon, {
            name: "i-heroicons-arrow-up-circle",
            class: "w-4 h-4 mr-2"
      ...
      _push(`</div></div><div class="flex items-center justify-between p-4 bg-[#0c0c0d] border border-[#2a2a2b] rounded-lg"><div class="flex items-center space-x-4"><div class="w-10 h-10 bg-[#1a1a1b] border border-[#2a2a2b] rounded-lg flex items-center justify-center">`);
      if (unref(independentSteps).restart.status === "completed") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-check",
        class: "w-5 h-5 text-green-400"
      }, null, _parent));
      else if (unref(independentSteps).restart.status === "error") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-x-mark",
        class: "w-5 h-5 text-red-400"
      }, null, _parent));
      else if (unref(independentSteps).restart.status === "in_progress") _push(ssrRenderComponent(_component_UIcon, {
        name: "i-heroicons-arrow-path",
        class: "w-5 h-5 text-blue-400 animate-spin"
      }, null, _parent));
      else _push(`<span class="text-sm font-medium text-gray-400">5</span>`);
      ...
      _push(ssrRenderComponent(_component_UBadge, {
        ...
        default: withCtx((_, _push$1, _parent$1, _scopeId) => {
          if (_push$1) _push$1(`${ssrInterpolate(getStepStatusText(unref(independentSteps).restart))}`);
          else return [createTextVNode(toDisplayString(getStepStatusText(unref(independentSteps).restart)), 1)];
        }),
        _: 1
      }, _parent));
      _push(ssrRenderComponent(_component_UButton, {
        ...
        default: withCtx((_, _push$1, _parent$1, _scopeId) => {
          if (_push$1) {
            ...
            _push$1(` ${ssrInterpolate(unref(independentSteps).restart.status === "completed" ? "\u91CD\u65B0\u542F\u52A8" : "\u91CD\u542F\u7CFB\u7EDF")}`);
          } else return [createVNode(_component_UIcon, {
            name: "i-heroicons-arrow-path",
            class: "w-4 h-4 mr-2"
...
var development_default = _sfc_main;

export { development_default as default };
//# sourceMappingURL=development-APhzOOll.mjs.map
