import { A, o as o$1 } from './keyboard-CvjRf4Wb.mjs';
import { i, c as c$1 } from './focus-management-DFaZHIRF.mjs';
import { a as w$1 } from './use-outside-click-B4rja7ys.mjs';
import { f as f$1, u as u$1 } from './hidden-Bsn3DsxF.mjs';
...
function n() {
  let o$1 = ref(0);
  return w$1("keydown", (e$1) => {
    e$1.key === "Tab" && (o$1.value = e$1.shiftKey ? 1 : 0);
  }), o$1;
}
function N({ defaultContainers: o$1$1 = [], portals: i$1, mainTreeNodeRef: H$1 } = {}) {
  let t = ref(null), r = i(t);
  function u$2() {
    var l, f$2, a;
    let n$1 = [];
    for (let e$1 of o$1$1) e$1 !== null && (e$1 instanceof HTMLElement ? n$1.push(e$1) : "value" in e$1 && e$1.value instanceof HTMLElement && n$1.push(e$1.value));
    if (i$1 != null && i$1.value) for (let e$1 of i$1.value) n$1.push(e$1);
    for (let e$1 of (l = r == null ? void 0 : r.querySelectorAll("html > *, body > *")) != null ? l : []) e$1 !== (void 0).body && e$1 !== (void 0).head && e$1 instanceof HTMLElement && e$1.id !== "headlessui-portal-root" && (e$1.contains(o$1(t)) || e$1.contains((a = (f$2 = o$1(t)) == null ? void 0 : f$2.getRootNode()) == null ? void 0 : a.host) || n$1.some((M$1) => e$1.contains(M$1)) || n$1.push(e$1));
    return n$1;
  }
  return {
...
var $ = defineComponent({
  ...
  setup(e$1, { slots: t, attrs: l }) {
    let r = ref(null);
    computed(() => i(r));
    let o$1$1 = s(), u$2 = inject(H, null), n$1 = ref(o$1$1 === true || u$2 == null ? x(r.value) : u$2.resolveTarget());
    n$1.value && M(n$1.value, (a) => a + 1);
    let c$1 = ref(false);
    watchEffect(() => {
      o$1$1 || u$2 != null && (n$1.value = u$2.resolveTarget());
    });
    let v$1 = inject(d, null), g = false;
    getCurrentInstance();
    return watch(r, () => {
      if (g || !v$1) return;
      o$1(r) && (g = true);
...
//# sourceMappingURL=portal-BLTG7ywv.mjs.map
