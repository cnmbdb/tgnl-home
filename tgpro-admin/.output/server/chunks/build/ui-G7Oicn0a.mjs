import { u as useAppConfig, l as omit, r as mergeConfig, c as get } from './server.mjs';
...
const useUI = (key, $ui, $config, $wrapperClass, withAppConfig = false) => {
  ...
  return {
    ui: computed(() => {
      ...
      return mergeConfig((_ui == null ? void 0 : _ui.strategy) || ((_a = appConfig.ui) == null ? void 0 : _a.strategy), _wrapperClass ? { wrapper: _wrapperClass } : {}, _ui || {}, withAppConfig ? get(appConfig.ui, key, {}) : {}, _config || {});
    }),
...
var table_default = {
  ...
  expand: { icon: "transform transition-transform duration-200" },
  progress: { wrapper: "absolute inset-x-0 -bottom-[0.5px] p-0" },
  default: {
...
var carousel_default = {
  ...
  arrows: { wrapper: "flex items-center justify-between" },
  indicators: {
...
var input_default = {
  ...
  file: { base: "file:mr-1.5 file:font-medium file:text-gray-500 dark:file:text-gray-400 file:bg-transparent file:border-0 file:p-0 file:outline-none" },
  size: {
    "2xs": "text-xs",
    "xs": "text-xs",
    "sm": "text-sm",
  ...
  color: {
    white: { outline: "shadow-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 dark:ring-gray-700 focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400" },
    gray: { outline: "shadow-sm bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 dark:ring-gray-700 focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400" }
  },
  variant: {
...
var verticalNavigation_default = {
  wrapper: "relative",
  ...
  divider: { wrapper: { base: "p-2" } }
};
var horizontalNavigation_default = {
...
export { verticalNavigation_default as A, contextMenu_default as B, notifications_default as C, popover_default as D, slideover_default as E, tooltip_default as F, badge_default as G, dropdown_default as H, kbd_default as I, progress_default as J, checkbox_default as K, formGroup_default as L, textarea_default as M, toggle_default as N, card_default as O, divider_default as P, modal_default as Q, notification_default as R, accordion_default as a, button_default as b, alert_default as c, avatarGroup_default as d, avatar_default as e, buttonGroup_default as f, carousel_default as g, chip_default as h, meterGroup_default as i, input_default as j, inputMenu_default as k, radio_default as l, meter_default as m, range_default as n, selectMenu_default as o, container_default as p, skeleton_default as q, radioGroup_default as r, select_default as s, table_default as t, useUI as u, breadcrumb_default as v, commandPalette_default as w, horizontalNavigation_default as x, pagination_default as y, tabs_default as z };
//# sourceMappingURL=ui-G7Oicn0a.mjs.map
