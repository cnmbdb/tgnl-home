import { f as nuxt_link_default, r as mergeConfig, i as twMerge, a as getNuxtLinkProps, d as virtual_nuxt__2FUsers_2Fhf_mac_2FDownloads_2Ftgpro_admin_2F_nuxt_2Fapp_config_default } from './server.mjs';
...
import { u as useUI, H as dropdown_default } from './ui-G7Oicn0a.mjs';
import Avatar_default from './Avatar-RiJ55zLR.mjs';
import Kbd_default from './Kbd-B6q0WgYi.mjs';
import { s, i, o as o$1, A, u, N, a as o } from './keyboard-CvjRf4Wb.mjs';
import { w, h as h$1, O, v, N as N$1, _ } from './focus-management-DFaZHIRF.mjs';
import { w as w$2 } from './use-outside-click-B4rja7ys.mjs';
import { s as s$1 } from './use-resolve-button-type-eioNRL5V.mjs';
import { u as u$1, i as i$1, f, c } from './calculate-active-index-B5ynhl2N.mjs';
...
var ge = defineComponent({
  ...
  setup(o$2, { slots: M, attrs: i$3 }) {
    ...
    return w$2([p$1, e], (t$1, a) => {
      var n;
      l$1.closeMenu(), w(a, h$1.Loose) || (t$1.preventDefault(), (n = o$1(p$1)) == null || n.focus());
    }, computed(() => I.value === 0)), provide(A$1, l$1), t(computed(() => u(I.value, {
      [0]: i$2.Open,
      [1]: i$2.Closed
    }))), () => {
      return A({
  ...
  setup(o$2, { attrs: M, slots: i$3, expose: I }) {
      ...
      switch (l$1.key) {
        ...
        case o.ArrowDown:
          l$1.preventDefault(), l$1.stopPropagation(), e.openMenu(), nextTick(() => {
            var t$1;
            (t$1 = o$1(e.itemsRef)) == null || t$1.focus({ preventScroll: true }), e.goToItem(c.First);
          });
          break;
        case o.ArrowUp:
          l$1.preventDefault(), l$1.stopPropagation(), e.openMenu(), nextTick(() => {
            var t$1;
            (t$1 = o$1(e.itemsRef)) == null || t$1.focus({ preventScroll: true }), e.goToItem(c.Last);
          });
          break;
      }
    }
    ...
    function d(l$1) {
      o$2.disabled || (e.menuState.value === 0 ? (e.closeMenu(), nextTick(() => {
        var t$1;
        return (t$1 = o$1(e.buttonRef)) == null ? void 0 : t$1.focus({ preventScroll: true });
      })) : (l$1.preventDefault(), e.openMenu(), te(() => {
        var t$1;
        return (t$1 = o$1(e.itemsRef)) == null ? void 0 : t$1.focus({ preventScroll: true });
      })));
    }
    let g = s$1(computed(() => ({
      as: o$2.as,
  ...
  setup(o$2, { attrs: M, slots: i$3, expose: I }) {
    ...
    function f$1(t$1) {
      ...
      switch (r.value && clearTimeout(r.value), t$1.key) {
        case o.Space:
          if (e.searchQuery.value !== "") return t$1.preventDefault(), t$1.stopPropagation(), e.search(t$1.key);
        case o.Enter:
          ...
          break;
        case o.ArrowDown:
          return t$1.preventDefault(), t$1.stopPropagation(), e.goToItem(c.Next);
        case o.ArrowUp:
          return t$1.preventDefault(), t$1.stopPropagation(), e.goToItem(c.Previous);
        case o.Home:
        case o.PageUp:
          return t$1.preventDefault(), t$1.stopPropagation(), e.goToItem(c.First);
        case o.End:
        case o.PageDown:
          return t$1.preventDefault(), t$1.stopPropagation(), e.goToItem(c.Last);
        case o.Escape:
          ...
          break;
        case o.Tab:
          t$1.preventDefault(), t$1.stopPropagation(), e.closeMenu(), nextTick(() => v(o$1(e.buttonRef), t$1.shiftKey ? N$1.Previous : N$1.Next));
          break;
        default:
  ...
  setup(o$2, { slots: M, attrs: i$3, expose: I }) {
    ...
    let f$1 = computed(() => e.activeItemIndex.value !== null ? e.items.value[e.activeItemIndex.value].id === p$1 : false), d = p(r);
    computed(() => ({
    ...
    return () => {
      ...
      return A({
        ourProps: {
          ...
          ref: r,
          role: "menuitem",
          tabIndex: u$2 === true ? void 0 : -1,
          "aria-disabled": u$2 === true ? true : void 0,
          onClick: b,
          onFocus: l$1,
          onPointerenter: a,
          onMouseenter: a,
...
//# sourceMappingURL=Dropdown-YMSaHnp6.mjs.map
