...
import { r as rt } from './combobox-D2aupXSo.mjs';
      ...
      default: withCtx(({ active, selected }, _push$1, _parent$1, _scopeId) => {
        if (_push$1) {
          ...
          ssrRenderSlot(_ctx.$slots, `${_ctx.group.key}-command`, {
            ...
            _push$1(`<span class="${ssrRenderClass([{ "flex-none": command.suffix || ((_a = command.matches) == null ? void 0 : _a.length) }, "truncate"])}"${_scopeId}>${ssrInterpolate(command[_ctx.commandAttribute])}</span>`);
            if ((_b = command.matches) == null ? void 0 : _b.length) _push$1(`<span class="${ssrRenderClass([command.suffixClass || _ctx.ui.group.command.suffix, "truncate"])}"${_scopeId}>${(_c = _ctx.highlight(command[_ctx.commandAttribute], command.matches[0])) != null ? _c : ""}</span>`);
          ...
          return [
            ...
            createVNode("span", { class: ["truncate", { "flex-none": command.suffix || ((_a = command.matches) == null ? void 0 : _a.length) }] }, toDisplayString(command[_ctx.commandAttribute]), 3),
          ...
          var _a;
          return [((_a = command.shortcuts) == null ? void 0 : _a.length) ? (openBlock(), createBlock("span", {
            key: 0,
...
//# sourceMappingURL=CommandPaletteGroup-Dpky3S1g.mjs.map
