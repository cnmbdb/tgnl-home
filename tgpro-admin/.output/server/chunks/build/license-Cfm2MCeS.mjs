  ...
  setup(__props) {
    ...
    const validateOrder = async () => {
      ...
      try {
        ...
        if (data == null ? void 0 : data.valid) toast.add({
          title: "\u9A8C\u8BC1\u6210\u529F",
    ...
    const deactivateLicense = async () => {
      ...
      try {
        if ((_a = await $fetch("/api/license/deactivate", {
          method: "POST",
          body: { orderNumber: licenseInfo.value.orderNumber }
        })) == null ? void 0 : _a.success) {
          toast.add({
            title: "\u53D6\u6D88\u6210\u529F",
        ...
        toast.add({
          title: "\u53D6\u6D88\u5931\u8D25",
          description: ((_b = error.data) == null ? void 0 : _b.message) || error.message || "\u65E0\u6CD5\u53D6\u6D88\u6388\u6743",
          icon: "i-heroicons-x-circle",
          color: "red"
        });
      } finally {
...
//# sourceMappingURL=license-Cfm2MCeS.mjs.map
