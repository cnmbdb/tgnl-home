import { d as i } from "./focus-management-DFaZHIRF.js";
...
function i$1({ container: e, accept: t, walk: d, enabled: o }) {
	watchEffect(() => {
		...
		let l = i(e);
		if (!l) return;
		let c$1 = Object.assign((f$1) => t(f$1), { acceptNode: t }), n = l.createTreeWalker(r$1, NodeFilter.SHOW_ELEMENT, c$1, !1);
...
export { u$1 as i, f as n, i$1 as r, c as t };

//# sourceMappingURL=calculate-active-index-B5ynhl2N.js.map