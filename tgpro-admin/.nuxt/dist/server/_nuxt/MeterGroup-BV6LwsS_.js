import { d as virtual_nuxt__2FUsers_2Fhf_mac_2FDownloads_2Ftgpro_admin_2F_nuxt_2Fapp_config_default, r as mergeConfig, t as getSlotsChildren } from "../server.mjs";
import "./components-D5RLOpR9.js";
import "./_plugin-vue_export-helper-COMwgem8.js";
import { t as Icon_default } from "./Icon-CrxV3u_Z.js";
import { A as meterGroup_default, W as useUI, j as meter_default } from "./ui-G7Oicn0a.js";
	...
	setup(props, { slots }) {
		...
		const vNodeChildren = computed(() => {
			...
			vNodeSlots[2] = h("ol", { class: ui.value.list }, labels.value.map((label, key) => {
				...
				}).value }, [h(Icon_default, { name: clones.value[key]?.props.icon ?? props.icon }), `${label} (${Math.round(percents.value[key])}%)`]);
			}));
			return vNodeSlots;
		});
		return () => h("div", {
...
//# sourceMappingURL=MeterGroup-BV6LwsS_.js.map