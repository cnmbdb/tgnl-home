...
import { C as selectMenu_default, W as useUI, w as select_default } from "./ui-G7Oicn0a.js";
...
import { c as o$1, i as N, l as i, n as A, o as T, r as E, s as u$2, t as o, u as s } from "./keyboard-CvjRf4Wb.js";
import { c as h$1, r as O, u as w$1 } from "./focus-management-DFaZHIRF.js";
import { t as w } from "./use-outside-click-B4rja7ys.js";
import { t as s$1 } from "./use-resolve-button-type-eioNRL5V.js";
import { i as u, n as f$1, t as c } from "./calculate-active-index-B5ynhl2N.js";
...
import { Fragment, Transition, computed, createBlock, createCommentVNode, createTextVNode, createVNode, defineComponent, h, inject, mergeProps, nextTick, openBlock, provide, ref, renderList, renderSlot, resolveComponent, resolveDynamicComponent, toDisplayString, toRaw, toRef, useId, useSSRContext, watch, watchEffect, withCtx } from "vue";
import { defu } from "/Users/hf-mac/Downloads/tgpro-admin/node_modules/defu/dist/defu.mjs";
import { computedAsync, useDebounceFn } from "@vueuse/core";
import { twJoin } from "tailwind-merge";
import { ssrIncludeBooleanAttr, ssrInterpolate, ssrRenderAttr, ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrRenderList, ssrRenderSlot, ssrRenderStyle, ssrRenderVNode } from "vue/server-renderer";
...
var Ie = defineComponent({
	...
	setup(o$2, { slots: b, attrs: r, emit: w$2 }) {
		...
		let D = computed(() => o$2.multiple ? 1 : 0), [y, L] = d(computed(() => o$2.modelValue), (t$1) => w$2("update:modelValue", t$1), computed(() => o$2.defaultValue)), M = computed(() => y.value === void 0 ? u$2(D.value, {
			[1]: [],
			[0]: void 0
		}) : y.value), k = {
			listboxState: n,
		...
		w([f$2, v], (t$1, i$2) => {
			var l$1;
			k.closeListbox(), w$1(i$2, h$1.Loose) || (t$1.preventDefault(), (l$1 = o$1(f$2)) == null || l$1.focus());
		}, computed(() => n.value === 0)), provide($, k), t(computed(() => u$2(n.value, {
			[0]: i$1.Open,
			[1]: i$1.Closed
		})));
		computed(() => {
...
defineComponent({
	...
	setup(o$2, { attrs: b, slots: r }) {
		...
		function e$1() {
			var v;
			(v = o$1(n.buttonRef)) == null || v.focus({ preventScroll: !0 });
		}
		return () => {
			let v = {
...
var je = defineComponent({
	...
	setup(o$2, { attrs: b, slots: r, expose: w$2 }) {
			...
			switch (a.key) {
				...
				case o.ArrowDown:
					a.preventDefault(), e$1.openListbox(), nextTick(() => {
						var u$3;
						(u$3 = o$1(e$1.optionsRef)) == null || u$3.focus({ preventScroll: !0 }), e$1.value.value || e$1.goToOption(c.First);
					});
					break;
				case o.ArrowUp:
					a.preventDefault(), e$1.openListbox(), nextTick(() => {
						var u$3;
						(u$3 = o$1(e$1.optionsRef)) == null || u$3.focus({ preventScroll: !0 }), e$1.value.value || e$1.goToOption(c.Last);
					});
					break;
			}
		}
		...
		function s$2(a) {
			e$1.disabled.value || (e$1.listboxState.value === 0 ? (e$1.closeListbox(), nextTick(() => {
				var u$3;
				return (u$3 = o$1(e$1.buttonRef)) == null ? void 0 : u$3.focus({ preventScroll: !0 });
			})) : (a.preventDefault(), e$1.openListbox(), me(() => {
				var u$3;
				return (u$3 = o$1(e$1.optionsRef)) == null ? void 0 : u$3.focus({ preventScroll: !0 });
			})));
		}
		let m = s$1(computed(() => ({
			as: o$2.as,
	...
	setup(o$2, { attrs: b, slots: r, expose: w$2 }) {
		...
		function v(a) {
			switch (f$2.value && clearTimeout(f$2.value), a.key) {
				case o.Space: if (e$1.searchQuery.value !== "") return a.preventDefault(), a.stopPropagation(), e$1.search(a.key);
				case o.Enter:
					...
					break;
				case u$2(e$1.orientation.value, {
				...
				case o.Home:
				case o.PageUp: return a.preventDefault(), a.stopPropagation(), e$1.goToOption(c.First);
				case o.End:
				case o.PageDown: return a.preventDefault(), a.stopPropagation(), e$1.goToOption(c.Last);
				case o.Escape:
		...
		return () => {
			...
			return A({
				ourProps: {
					...
					"aria-multiselectable": e$1.mode.value === 1 ? !0 : void 0,
	...
	setup(o$2, { slots: b, attrs: r, expose: w$2 }) {
		...
		let v = computed(() => e$1.activeOptionIndex.value !== null ? e$1.options.value[e$1.activeOptionIndex.value].id === n : !1), s$2 = computed(() => u$2(e$1.mode.value, {
		...
		function u$3(t$1) {
			...
			e$1.select(o$2.value), e$1.mode.value === 0 && (e$1.closeListbox(), nextTick(() => {
				var i$2;
				return (i$2 = o$1(e$1.buttonRef)) == null ? void 0 : i$2.focus({ preventScroll: !0 });
			}));
		}
		function D() {
		...
		return () => {
			...
			return A({
				ourProps: {
					...
					ref: f$2,
					role: "option",
					tabIndex: t$1 === !0 ? void 0 : -1,
					"aria-disabled": t$1 === !0 ? !0 : void 0,
...
//# sourceMappingURL=SelectMenu-D72j-RJr.js.map