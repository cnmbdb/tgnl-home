import { E as useRuntimeConfig, T as useNuxtApp, b as useHead, g as useAsyncData, u as useAppConfig } from "../server.mjs";
import { computed, defineComponent, h, onServerPrefetch, watch } from "vue";
import { Icon, addIcon, getIcon, loadIcon } from "@iconify/vue";
...
const NuxtIconCss = /* @__PURE__ */ defineComponent({
	...
	setup(props) {
		...
		onServerPrefetch(async () => {
			if (!((/* @__PURE__ */ useRuntimeConfig()).icon || {})?.serverKnownCssClasses?.includes(cssClass.value)) {
...
export { components_default as t };

//# sourceMappingURL=components-D5RLOpR9.js.map