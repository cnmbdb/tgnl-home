import { c as o, s as u } from "./keyboard-CvjRf4Wb.js";
...
function w(e, r = 0) {
	var t;
	return e === ((t = i(e)) == null ? void 0 : t.body) ? !1 : u(r, {
		[0]() {
			return e.matches(c);
		},
		[1]() {
...
function P(e, r, { sorted: t = !0, relativeTo: l = null, skipElements: o$1 = [] } = {}) {
	var m;
	...
	let x = (() => {
		...
		throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
	})(), L = r & 32 ? { preventScroll: !0 } : {}, a = 0, d$1 = n$1.length, u$1;
	do {
		...
		u$1 = n$1[s$1], u$1?.focus(L), a += x;
	} while (u$1 !== i$2.activeElement);
	return r & 6 && I(u$1) && u$1.select(), 2;
}
export { S as a, h$1 as c, i as d, c$1 as f, P as i, v as l, N as n, T as o, O as r, _ as s, E as t, w as u };

//# sourceMappingURL=focus-management-DFaZHIRF.js.map