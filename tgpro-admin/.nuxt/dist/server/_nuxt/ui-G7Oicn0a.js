import { c as get, l as omit, r as mergeConfig, u as useAppConfig } from "../server.mjs";
...
const useUI = (key, $ui, $config, $wrapperClass, withAppConfig = false) => {
	...
	return {
		ui: computed(() => {
			...
			return mergeConfig(_ui?.strategy || appConfig.ui?.strategy, _wrapperClass ? { wrapper: _wrapperClass } : {}, _ui || {}, withAppConfig ? get(appConfig.ui, key, {}) : {}, _config || {});
		}),
...
export { meterGroup_default as A, badge_default as B, selectMenu_default as C, inputMenu_default as D, formGroup_default as E, accordion_default as F, avatar_default as H, dropdown_default as I, chip_default as L, progress_default as M, kbd_default as N, input_default as O, alert_default as P, buttonGroup_default as R, radioGroup_default as S, textarea_default as T, table_default as U, avatarGroup_default as V, useUI as W, card_default as _, tooltip_default as a, checkbox_default as b, breadcrumb_default as c, commandPalette_default as d, horizontalNavigation_default as f, container_default as g, skeleton_default as h, popover_default as i, meter_default as j, carousel_default as k, tabs_default as l, divider_default as m, notification_default as n, slideover_default as o, verticalNavigation_default as p, contextMenu_default as r, modal_default as s, notifications_default as t, pagination_default as u, range_default as v, select_default as w, radio_default as x, toggle_default as y, button_default as z };

//# sourceMappingURL=ui-G7Oicn0a.js.map