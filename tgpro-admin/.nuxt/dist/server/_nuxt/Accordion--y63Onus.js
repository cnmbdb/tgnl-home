import { d as virtual_nuxt__2FUsers_2Fhf_mac_2FDownloads_2Ftgpro_admin_2F_nuxt_2Fapp_config_default, l as omit, r as mergeConfig } from "../server.mjs";
...
import { F as accordion_default, W as useUI, z as button_default } from "./ui-G7Oicn0a.js";
import { c as o$1, i as N$1, l as i, n as A, s as u, t as o, u as s } from "./keyboard-CvjRf4Wb.js";
...
import { Transition, computed, createBlock, createCommentVNode, createTextVNode, createVNode, defineComponent, inject, mergeProps, openBlock, provide, ref, renderSlot, resolveComponent, toDisplayString, toRef, useId, useSSRContext, vShow, watch, watchEffect, withCtx, withDirectives, withKeys } from "vue";
import { ssrInterpolate, ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderSlot, ssrRenderStyle } from "vue/server-renderer";
...
var N = defineComponent({
	...
	setup(t$1, { slots: r, attrs: o$2 }) {
		let s$2 = ref(t$1.defaultOpen ? 0 : 1), e = ref(null), i$2 = ref(null), n = {
			buttonId: ref(`headlessui-disclosure-button-${i()}`),
			panelId: ref(`headlessui-disclosure-panel-${i()}`),
			disclosureState: s$2,
			panel: e,
			button: i$2,
			toggleDisclosure() {
			...
			close(l$1) {
				n.closeDisclosure();
				(() => l$1 ? l$1 instanceof HTMLElement ? l$1 : l$1.value instanceof HTMLElement ? o$1(l$1) : o$1(n.button) : o$1(n.button))()?.focus();
			}
		};
	...
	setup(t$1, { attrs: r, slots: o$2, expose: s$2 }) {
		let e = O("DisclosureButton"), i$2 = U(), n = computed(() => i$2 === null ? !1 : i$2.value === e.panelId.value);
		let l$1 = ref(null);
		s$2({
			el: l$1,
			$el: l$1
		...
		return () => {
			...
			return A({
				ourProps: n.value ? {
					...
					disabled: t$1.disabled ? !0 : void 0,
					onClick: c,
					onKeydown: D,
					onKeyup: v
				},
	...
	setup(t$1, { attrs: r, slots: o$2, expose: s$2 }) {
		...
		let i$2 = l(), n = computed(() => i$2 !== null ? (i$2.value & i$1.Open) === i$1.Open : e.disclosureState.value === 0);
		return () => {
			var v;
			let l$1 = {
...
//# sourceMappingURL=Accordion--y63Onus.js.map