...
import { W as useUI, l as tabs_default } from "./ui-G7Oicn0a.js";
import { t } from "./micro-task-CYdHJ3PN.js";
import { c as o$1, i as N$1, l as i, n as A, o as T$1, s as u, t as o, u as s } from "./keyboard-CvjRf4Wb.js";
import { d as i$1, i as P, n as N, o as T, r as O } from "./focus-management-DFaZHIRF.js";
import { t as s$1 } from "./use-resolve-button-type-eioNRL5V.js";
import { n as u$1, t as f } from "./hidden-Bsn3DsxF.js";
import { Fragment, computed, createBlock, createCommentVNode, createTextVNode, createVNode, defineComponent, h, inject, mergeProps, nextTick, openBlock, provide, ref, renderList, renderSlot, resolveComponent, toDisplayString, toRef, useId, useSSRContext, watch, watchEffect, withCtx } from "vue";
...
var G = Symbol("TabsSSRContext"), me = defineComponent({
	...
	setup(a, { slots: b, attrs: s$2, emit: d$1 }) {
		...
		function y(t$1) {
			...
			if (t$1 < 0 || t$1 > n.length - 1) {
				let m = u(u(i$2.value === null ? 0 : Math.sign(t$1 - i$2.value), {
					[-1]: () => 1,
					[0]: () => u(Math.sign(t$1), {
						[-1]: () => 0,
						[0]: () => 0,
		...
		return watchEffect(() => {
			...
			return h(Fragment, [l.value.length <= 0 && h(d, { onFocus: () => {
				for (let n of l.value) {
					let o$2 = o$1(n);
					if ((o$2 == null ? void 0 : o$2.tabIndex) === 0) return o$2.focus(), !0;
				}
				return !1;
			} }), A({
				theirProps: {
	...
	setup(a, { attrs: b, slots: s$2, expose: d$1 }) {
		...
		function T$2(e) {
			var I;
			let c = e();
			if (c === T.Success && l.activation.value === "auto") {
		...
		function x(e) {
			...
			switch (e.key) {
				case o.Home:
				case o.PageUp: return e.preventDefault(), e.stopPropagation(), T$2(() => P(c, N.First));
				case o.End:
				case o.PageDown: return e.preventDefault(), e.stopPropagation(), T$2(() => P(c, N.Last));
			}
			if (T$2(() => u(l.orientation.value, {
				vertical() {
					return e.key === o.ArrowUp ? P(c, N.Previous | N.WrapAround) : e.key === o.ArrowDown ? P(c, N.Next | N.WrapAround) : T.Error;
				},
				horizontal() {
					return e.key === o.ArrowLeft ? P(c, N.Previous | N.WrapAround) : e.key === o.ArrowRight ? P(c, N.Next | N.WrapAround) : T.Error;
				}
			})) === T.Success) return e.preventDefault();
		}
		let w = ref(!1);
		function E() {
			var e;
			w.value || (w.value = !0, !a.disabled && ((e = o$1(r)) == null || e.focus({ preventScroll: !0 }), l.setSelectedIndex(y.value), t(() => {
				w.value = !1;
			})));
		}
		function t$1(e) {
...
//# sourceMappingURL=Tabs-BA-VGK81.js.map