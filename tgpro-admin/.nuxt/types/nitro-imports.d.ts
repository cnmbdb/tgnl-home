declare global {
  const ZibllAPI: typeof import('../../server/utils/zibll').ZibllAPI
  ...
  const createZibllClient: typeof import('../../server/utils/zibll').createZibllClient
  ...
  const executeQuery: typeof import('../../server/utils/database').executeQuery
  const extractLicenseInfo: typeof import('../../server/utils/wordpress-db').extractLicenseInfo
  ...
  const getWordPressOrder: typeof import('../../server/utils/wordpress-db').getWordPressOrder
  ...
  const licenseValidator: typeof import('../../server/utils/license-validator').default
  ...
  const validateWordPressOrder: typeof import('../../server/utils/wordpress-db').validateWordPressOrder
  const writeEarlyHints: typeof import('../../node_modules/h3').writeEarlyHints
}
// for type re-export
declare global {
  // @ts-ignore
  export type { UserPayload } from '../../server/utils/auth'
  import('../../server/utils/auth')
  // @ts-ignore
  export type { ZibllAPI, ZibllConfig } from '../../server/utils/zibll'
  import('../../server/utils/zibll')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/hf-mac/Downloads/tgpro-admin/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Users/hf-mac/Downloads/tgpro-admin/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { requireAuth, requireAdmin } from '/Users/hf-mac/Downloads/tgpro-admin/server/utils/auth';
export { loadConfig } from '/Users/hf-mac/Downloads/tgpro-admin/server/utils/config';
export { executeQuery } from '/Users/hf-mac/Downloads/tgpro-admin/server/utils/database';
export { default as licenseValidator } from '/Users/hf-mac/Downloads/tgpro-admin/server/utils/license-validator';
export { getWordPressOrder, validateWordPressOrder, extractLicenseInfo } from '/Users/hf-mac/Downloads/tgpro-admin/server/utils/wordpress-db';
export { ZibllAPI, createZibllClient } from '/Users/hf-mac/Downloads/tgpro-admin/server/utils/zibll';