    ...
    try {
      ...
      try {
        ...
        for (const process2 of pm2Processes) {
          if (process2.pm2_env && process2.pm2_env.pm_exec_path && (process2.pm2_env.pm_exec_path.includes("al.py") || process2.name.includes("bot") || process2.name.includes("tgpro"))) {
