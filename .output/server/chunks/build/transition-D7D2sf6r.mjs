import { defineComponent, ref, h, computed, onMounted, onUnmounted, watchEffect, watch, provide, normalizeClass, inject, Fragment, shallowRef, nextTick } from 'vue';
import { q, N as N$2, E as E$1, u as u$2, $ as $$1, z as z$1, n, d as d$1$1 } from './portal-RXXuCQxI.mjs';
import { f, u as u$3 } from './hidden-Dc_fFmis.mjs';
import { o, t as t$3 } from './active-element-history-Cer4cSOw.mjs';
import { S, i as i$1, u as u$1, o as o$1, A as A$2, T as T$1, a as o$2, N as N$4 } from './keyboard-Duq8EHr3.mjs';
import { c as c$1, i as i$3, S as S$1, P, N as N$3, T as T$2 } from './focus-management-vHH7q6nP.mjs';
import { t as t$2 } from './micro-task-B6uncIso.mjs';
import { w as w$1, t as t$4 } from './use-outside-click-BHqYmLlt.mjs';
import { s as s$1, t as t$1, l as l$2, i as i$2 } from './open-closed-BDzQJ33n.mjs';
import { k } from './description-CsZvF7Vz.mjs';
...
let ue = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(t2, { attrs: n$1, slots: r, expose: l2 }) {
  ...
  function H2(u2) {
    ...
    d2 instanceof HTMLElement && d2.dataset.headlessuiFocusGuard !== "true" && (N$1(T2, d2) || (s2.value ? P(o$1(o$12), u$1(f$1.value, { [d$1$1.Forwards]: () => N$3.Next, [d$1$1.Backwards]: () => N$3.Previous }) | N$3.WrapAround, { relativeTo: u2.target }) : u2.target instanceof HTMLElement && S$1(u2.target)));
  }
  return () => {
  ...
  return onMounted(() => i2.value = true), onUnmounted(() => i2.value = false), onMounted(() => {
    watch([n2, r, l2], (e, m2) => {
      ...
      f2 && t$2(() => {
        ...
        a2 ? S$1(a2) : P(f2, N$3.First | N$3.NoScroll) === T$2.Error && console.warn("There are no focusable elements inside the <FocusTrap />"), o$12.value = (H2 = t2.value) == null ? void 0 : H2.activeElement;
      });
...
let W = N$4.RenderStrategy, he = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t2, attrs: a2, slots: s2, expose: h$1 }) {
  ...
  }), provide(N, P2), t$1(computed(() => u$1(i2.value, { ["visible"]: i$2.Open, ["hidden"]: i$2.Closed }) | n2.value)), () => {
...
//# sourceMappingURL=transition-D7D2sf6r.mjs.map
