...
import { defineComponent, computed, onMounted, watch, ref, inject, onUnmounted, watchEffect, nextTick, provide, h, Fragment, toRaw, reactive, cloneVNode } from 'vue';
import { d, e } from './form-DsUILy5F.mjs';
import { o, t as t$2 } from './active-element-history-Cer4cSOw.mjs';
import { i as i$1, o as o$1, A, T, u, E, N, a as o$2 } from './keyboard-Duq8EHr3.mjs';
import { w, n } from './use-outside-click-BHqYmLlt.mjs';
...
let nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a, { attrs: h2, slots: r, expose: y }) {
  ...
  var V;
  let u2 = (V = a.id) != null ? V : `headlessui-combobox-input-${i$1()}`, e2 = K("ComboboxInput"), c$1 = computed(() => i$2(o$1(e2.inputRef))), f2 = { value: false };
...
//# sourceMappingURL=combobox-BrA0ilcp.mjs.map
